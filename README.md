...
| File | What |
|---|---|
| `data/plugins.jsonl` · `invalid.jsonl` | <!-- stats:begin -->**Authoritative set 12,102** + 4,487 noise buckets (0 duplicates · hard gate · 2026-09-23 snapshot, validation still rolling)<!-- stats:end --> |
