...
| File | What |
|---|---|
| `data/plugins.jsonl` · `invalid.jsonl` | <!-- stats:begin -->**Authoritative set 11,191** + 4,206 noise buckets (0 duplicates · hard gate · 2026-09-14 snapshot, validation still rolling)<!-- stats:end --> |
