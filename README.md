...
| File | What |
|---|---|
| `data/plugins.jsonl` · `invalid.jsonl` | <!-- stats:begin -->**Authoritative set 11,515** + 4,325 noise buckets (0 duplicates · hard gate · 2026-09-18 snapshot, validation still rolling)<!-- stats:end --> |
