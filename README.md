...
| File | What |
|---|---|
| `data/plugins.jsonl` · `invalid.jsonl` | <!-- stats:begin -->**Authoritative set 11,419** + 4,282 noise buckets (0 duplicates · hard gate · 2026-09-17 snapshot, validation still rolling)<!-- stats:end --> |
