...
| File | What |
|---|---|
| `data/plugins.jsonl` · `invalid.jsonl` | <!-- stats:begin -->**Authoritative set 11,326** + 4,265 noise buckets (0 duplicates · hard gate · 2026-09-15 snapshot, validation still rolling)<!-- stats:end --> |
