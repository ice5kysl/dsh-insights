#!/usr/bin/env node
/**
 * pipeline/content · insights — LLM 阶段性生态洞察报告
 *
 * 与周报的分工：周报是事实编年（数字罗列）+ 轻量三小节（编者按/本周洞察/行动建议），
 * 洞察是独立深度文档（结论/建议/异常应对）。
...
const wk = WK_OVERRIDE || lastCompleteIsoWeek(new Date())
...
const headZh = `> 由 DSH Insights 管线 + AI 生成 · 数据快照 ${pack.snapshot} · 启发式评估，非安全审计\n\n`
const headEn = `> Generated by the DSH Insights pipeline + AI · snapshot ${pack.snapshot} · heuristic evaluation, not a security audit\n\n`
