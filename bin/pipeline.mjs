...
const DAILY = ['lists', 'discover-incr', 'validate', 'downloads', 'dynamics', 'shell-seeds', 'shell-rows', 'compat', 'analyze', 'export-json', 'compat-observed', 'site', 'export-csv', 'diff', 'db9-sync', 'crash-corpus', 'traffic', 'pages']
...
const PROFILES = {
  ...
  friday: ['lists', 'discover', 'refresh', 'downloads', 'dynamics', 'compat', 'analyze', 'site', 'export-csv', 'diff', 'author-graph', 'metrics', 'letters', 'weekly', 'insights', 'db9-sync', 'crash-corpus', 'traffic', 'pages'],
  snapshot: SNAPSHOT,
  full: ['lists', 'discover', 'npm-map', 'downloads', 'validate', ...SNAPSHOT, 'db9-sync', 'crash-corpus', 'traffic', 'diff'],
  content: CONTENT,
}
