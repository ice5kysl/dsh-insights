...
> wang-kaopu/dsh-oauth · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Use ChatGPT (Codex) and Gemini Code Assist subscriptions as DeepSeek Harness LLM providers — OAuth login in the web UI, no API keys
