...
> V-dev-388/dsh-usage-meter · 第 1 期（数据快照 2026-09-06）
...
- ★1 · DSH (DeepSeek Harness) model usage dashboard plugin: settings panel with per-provider/model token summary and today/7d/30d trends
...
```text
Add V-dev-388/dsh-usage-meter to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-usage-meter@0.1.3.
```
