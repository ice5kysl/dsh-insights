...
> V-dev-388/dsh-usage-meter · 第 1 期（数据快照 2026-09-14）
...
- ★0 · DSH (DeepSeek Harness) model usage dashboard plugin: settings panel with per-provider/model token summary and today/7d/30d trends
- npm：`dsh-usage-meter@0.1.3`（4 个版本）
- 周下载：**75**
- 最近 push 2026-08-25
