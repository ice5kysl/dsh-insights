...
> iyllyt/dsh-btw · 第 1 期（数据快照 2026-09-14）
...
- ★10 · 个人很喜欢 Claude Code 的 /btw，于是为 DSH 做了复刻：共享当前上下文快速旁路提问，不中断主任务，也不写入主会话历史。
- npm：`dsh-btw@0.0.3`（3 个版本）
- 周下载：**259**
- 最近 push 2026-09-12

以下几项检查未发现问题（仅作记录）：client 导出齐备、产物布局规范、files 白名单、npm 已发布、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「共享当前上下文进行快速旁路提问，不中断主任务，不写入主会话历史。」。
