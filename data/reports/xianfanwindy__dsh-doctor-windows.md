...
> xianfanwindy/dsh-doctor-windows · 第 1 期（数据快照 2026-09-06）
...
```text
Add xianfanwindy/dsh-doctor-windows to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-doctor-windows@0.1.0.
```
