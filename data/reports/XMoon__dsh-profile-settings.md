...
> XMoon/dsh-profile-settings · 第 1 期（数据快照 2026-09-15）
...
- ★2 · Per-profile settings overlay for DeepSeek Harness: global settings.yaml plus profiles/<name>/settings.patch.yml, transparently layered under ctx.settings
