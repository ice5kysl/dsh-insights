...
> Flan246/dsh-latex-guard · 第 1 期（数据快照 2026-09-21）
...
- npm：`dsh-latex-guard@0.1.3`（4 个版本）
- 周下载：**157**
- 最近 push 2026-09-09

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「LaTeX编译检查与BibTeX工具插件，提供lint、补全和审计能力，支持DSH插件、CLI和SKILL.md三种使用方式。」。
