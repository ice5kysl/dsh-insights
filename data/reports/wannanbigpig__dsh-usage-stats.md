...
> wannanbigpig/dsh-usage-stats · 第 1 期（数据快照 2026-09-21）
...
- ★3 · DeepSeek Harness web 用量与计费插件：官方余额、Token 用量、贡献热图与按小时计费统计。Balance, token usage, contribution heatmap & per-hour cost stats for dsh web.
- npm：`@wannanbigpig/dsh-usage-stats@0.5.2`（15 个版本）
- 周下载：**220**
- 最近 push 2026-09-15
