...
> linhay/harmony-next.skills · 第 1 期（数据快照 2026-09-21）
...
- ★352 · 🚀 Expert guidance for HarmonyOS NEXT (API 12+) development. Covers IDE operations, performance tuning, architecture (HAP/HAR/HSP), and automation testing.
- npm：尚未发布
- 最近 push 2026-09-20
