...
> AlfredChaos/dsh-usage-panel · 第 1 期（数据快照 2026-09-21）
...
- ★7 · DeepSeek Harness 消耗统计插件：设置页 Token 用量 KPI、半年活跃热力图、按模型堆叠柱状图与模型环形图（dsh-plugin）
- npm：`dsh-usage-panel@0.2.3`（3 个版本）
- 周下载：**146**
- 最近 push 2026-09-15
