...
> ZSeven-W/dsh-ios · 第 1 期（数据快照 2026-09-14）
...
- ★290 · DeepSeek Harness (DSH) plugin: a live iOS Simulator — and a USB-connected iPhone — inside the conversation. 22 agent tools for booting, building, driving the UI
- npm：尚未发布
- 周下载：**489**
- 最近 push 2026-09-11

以下几项检查未发现问题（仅作记录）：client 导出齐备、产物布局规范、files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「在对话内控制iOS模拟器或USB连接的iPhone，提供22个代理工具与可拖拽侧边栏。」。
