...
> Vncntvx/dsh-zotero · 第 1 期（数据快照 2026-09-06）
...
- ★11 · Turn your Zotero library into an evidence store for agents.
- npm：`dsh-zotero@0.6.0`（14 个版本）
- 最近 push 2026-09-03 · 收录：awesome — · imsai —

**做得好的**：files 白名单、npm 已发布、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「将Zotero文献库转为供智能体使用的证据存储。」。这些是你的基本盘，保持即可。
...
```text
Add Vncntvx/dsh-zotero to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-zotero@0.6.0.
```
