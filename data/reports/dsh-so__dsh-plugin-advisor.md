...
> dsh-so/dsh-plugin-advisor · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Natural-language plugin search for DeepSeek Harness — ask what you need, get matching dsh.so plugins with install commands.
- npm：`@dsh-so/dsh-plugin-advisor@0.2.1`（2 个版本）
- 周下载：**20**
- 最近 push 2026-09-11
