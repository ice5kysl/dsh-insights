...
> hellosz/dsh-pets · 第 1 期（数据快照 2026-09-06）
...
- ★5 · （无描述）
- npm：`@hellosz/dsh-pets@0.3.1`（5 个版本）
...
```text
Add hellosz/dsh-pets to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @hellosz/dsh-pets@0.3.1.
```
