...
> pengyue-polaron/deepseek-harness-genui · 第 1 期（数据快照 2026-09-15）
...
- ★109 · Task-specific React apps for DeepSeek Harness with state carried into the next Agent turn
- npm：`dsh-plugin-genui@0.14.0`（5 个版本）
- 周下载：**419**
- 最近 push 2026-09-06

以下几项检查未发现问题（仅作记录）：client 导出齐备、产物布局规范、files 白名单、npm 已发布、npm 版本同步、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「为DeepSeek Harness创建特定任务React应用，并将状态延续到下一Agent轮。」。
