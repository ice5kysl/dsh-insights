...
> Jiangsubei/dsh-qqbot-bridge · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DeepSeek Harness × QQ 官方机器人插件 —— 用 **QQ 单聊**远程控制 DSH 里已有的所有工作区会话：流式输出、Markdown 渲染、文件收发、命令系统。
- npm：`dsh-qqbot-bridge@0.1.1`（2 个版本）
- 周下载：**215**
- 最近 push 2026-09-18
