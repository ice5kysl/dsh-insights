...
> luweiyabo/dsh-whale-pet · 第 1 期（数据快照 2026-09-14）
...
- ★5 · DeepSeek Harness Web UI 的开源鲸鱼桌宠插件，支持 Agent 状态感知、多种透明动画、点击拖拽、屏幕漫游、自定义动作与触发规则。
- npm：`@luweiyabo/dsh-whale-pet@0.1.2`（2 个版本）
- 周下载：**100**
- 最近 push 2026-09-06
