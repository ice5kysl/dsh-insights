...
> wanghj040530/dsh-swarm · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Autonomous team collaboration plugin for DeepSeek Harness: captain splits tasks, specialized members with independent API/plugins run in isolated DSH subprocess
