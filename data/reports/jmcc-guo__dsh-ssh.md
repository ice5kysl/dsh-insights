...
> jmcc-guo/dsh-ssh · 第 1 期（数据快照 2026-09-06）
...
- ★5 · SSH terminal panel & AI connection manager for DeepSeek Harness — model-driven connect/exec/list/status/disconnect tools plus an XShell-style multi-tab terminal
- npm：`@jmcc-guo/dsh-ssh@0.4.0`（10 个版本）
...
```text
Add jmcc-guo/dsh-ssh to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @jmcc-guo/dsh-ssh@0.4.0.
```
