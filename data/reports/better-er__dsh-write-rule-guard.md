...
> better-er/dsh-write-rule-guard · 第 1 期（数据快照 2026-09-21）
...
- ★3 · dsh 插件：按可配置正则规则拦截 edit/write 的写入内容，默认拦全角括号，host 单半身经 cordis 配置注入。
- npm：`dsh-write-rule-guard@0.3.0`（4 个版本）
- 周下载：**267**
- 最近 push 2026-09-14
