...
> leozou320-ai/dsh-macos-vision-ocr · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Offline macOS Vision OCR for DeepSeek Harness — accurate, local, API-key free. | DeepSeek Harness 本地离线 OCR 插件
- npm：尚未发布
- 最近 push 2026-08-16
