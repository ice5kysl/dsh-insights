...
> white-sand-grand/dsh-plugin-doctor · 第 1 期（数据快照 2026-09-06）
...
- ★6 · 致力于解决各插件之间也与版本之间可能存在的冲突问题并提供解决方案
...
```text
Add white-sand-grand/dsh-plugin-doctor to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-plugin-doctor@0.1.1.
```
