...
> seriousz158/dsh-memory · 第 1 期（数据快照 2026-09-21）
...
- ★180 · （无描述）
- npm：`dsh-git-memory@0.8.1`（2 个版本）
- 周下载：**127**
- 最近 push 2026-09-20

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「为 DeepSeek Harness 提供记忆能力。」。
