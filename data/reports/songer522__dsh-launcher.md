...
> songer522/dsh-launcher · 第 1 期（数据快照 2026-09-11）
...
- ★0 · macOS menu bar app for the DeepSeek Harness web server, with a Host plugin that publishes the running server's port, PID and tokenized URL
- npm：尚未发布
- 最近 push 2026-09-09
