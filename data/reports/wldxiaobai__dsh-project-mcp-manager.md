...
> wldxiaobai/dsh-project-mcp-manager · 第 1 期（数据快照 2026-09-21）
...
- ★4 · 基于原版 DSH 扩展，提供项目层、用户层更完整 MCP 管理 || Extended from the original DSH code, providing more complete MCP management at both project and user levels
