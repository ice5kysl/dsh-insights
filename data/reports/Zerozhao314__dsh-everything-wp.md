...
> Zerozhao314/dsh-everything-wp · 第 1 期（数据快照 2026-09-21）
...
- ★0 · 专为 WordPress 建站调试打造的 Skill 集合 · 包含 DeepSeek Harness (DSH) Plugin 开发 Skill + WordPress 插件开发 AI 工具包（5 Agents + 18 命令，规划→执行→审查→质量验证完整工作流） / WordPress site-building
- npm：尚未发布
- 最近 push 2026-08-17
