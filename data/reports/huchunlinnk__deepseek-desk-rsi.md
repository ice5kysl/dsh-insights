...
> huchunlinnk/deepseek-desk-rsi · 第 1 期（数据快照 2026-09-21）
...
- ★3 · Recursive Self-Improvement engine for DeepSeek Harness — DSH maintains DSH: bounded perceive→integrate→verify→parity→repair→propose loop enforcing 1:1 upstream 
- npm：尚未发布
- 最近 push 2026-08-18
