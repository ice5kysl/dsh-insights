...
> falling-ts/dsh-force-compact · 第 1 期（数据快照 2026-09-15）
...
- ★5 · Aggressive context compaction for local-first agents. Runs Qwen3.8‑27B on self‑hosted llama.cpp at low context, shrinking history so the live prompt stays small
