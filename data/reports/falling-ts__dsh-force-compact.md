...
> falling-ts/dsh-force-compact · 第 1 期（数据快照 2026-09-14）
...
- ★4 · Aggressive context compaction for local-first agents. Runs Qwen3.8‑27B on self‑hosted llama.cpp at low context, shrinking history so the live prompt stays small
- npm：`@falling-ts/dsh-force-compact@0.3.3`（13 个版本）
- 周下载：**844**
- 最近 push 2026-09-10
