...
> new-256/dsh-session-cleaner · 第 1 期（数据快照 2026-09-14）
...
- ★0 · DSH 会话清理宿主插件：侧边栏原生「移入回收站」+ 回收站管理页 + HTTP API（两级可恢复删除、同名防删错、活跃会话保护）
- npm：`@luchenglong/dsh-session-cleaner@1.2.1`（2 个版本）
- 周下载：**296**
- 最近 push 2026-09-09
