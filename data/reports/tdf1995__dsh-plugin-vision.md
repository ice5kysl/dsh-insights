...
> tdf1995/dsh-plugin-vision · 第 1 期（数据快照 2026-09-21）
...
- ★4 · Vision for text-only LLMs in DeepSeek Harness (DSH): describe images / OCR / VQA via free Gemini & GLM vision APIs
