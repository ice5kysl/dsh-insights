...
> yushenghai1106/dsh-memory-plugin · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Pluggable persistent memory bundle for DeepSeek Harness
- npm：`@yushenghai/dsh-memory-plugin@0.1.0`（1 个版本）
- 周下载：**45**
- 最近 push 2026-09-03
