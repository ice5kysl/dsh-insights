...
> loyalchiiina/dsh-skill-browser · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DSH skill library browser with floating ball panel, categories, Chinese descriptions, and an automatic skill-failure ledger (tools/result based). DSH 技能浏览器：悬浮球面
- npm：`dsh-skill-browser@1.8.1`（11 个版本）
- 周下载：**299**
- 最近 push 2026-09-18
