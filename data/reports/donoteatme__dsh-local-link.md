...
> donoteatme/dsh-local-link · 第 1 期（数据快照 2026-09-15）
...
- ★0 · Lightweight DeepSeek Harness plugin for paired LAN access: scan a QR code and continue the current DSH Web session from any phone, tablet, or computer.
- npm：`dsh-local-link@1.0.0`（4 个版本）
- 周下载：**182**
- 最近 push 2026-09-12
