...
> xswt442-cmd/dsh-instance-manager · 第 1 期（数据快照 2026-09-15）
...
- ★2 · DSH 常驻插件：侧边栏面板统一查看并管理本机的 dsh 实例 | Sidebar panel to list and manage local dsh web instances
- npm：`dsh-instance-manager@0.9.5`（13 个版本）
- 周下载：**133**
- 最近 push 2026-09-14
