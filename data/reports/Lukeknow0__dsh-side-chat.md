...
> Lukeknow0/dsh-side-chat · 第 1 期（数据快照 2026-09-14）
...
- ★3 · Read-only side chat plugin for DeepSeek Harness (DSH) — ask temporary questions with inherited context while the parent agent keeps running.
- npm：`@lukeknow0/dsh-side-chat@0.4.0`（2 个版本）
- 周下载：**41**
- 最近 push 2026-08-23
