...
> Lukeknow0/dsh-side-chat · 第 1 期（数据快照 2026-09-11）
...
- ★4 · Read-only side chat plugin for DeepSeek Harness (DSH) — ask temporary questions with inherited context while the parent agent keeps running.
