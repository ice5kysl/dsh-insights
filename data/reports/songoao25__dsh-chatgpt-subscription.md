...
> songoao25/dsh-chatgpt-subscription · 第 1 期（数据快照 2026-09-06）
...
- ★3 · ChatGPT Subscription - a DeepSeek Harness plugin: bind your ChatGPT account via official OAuth and chat with ChatGPT models inside DSH, using your Plus/Pro subs
- npm：尚未发布
...
```text
Add songoao25/dsh-chatgpt-subscription to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
