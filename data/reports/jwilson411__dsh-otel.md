...
> jwilson411/dsh-otel · 第 1 期（数据快照 2026-09-14）
...
- ★0 · DeepSeek Harness plugin: emit OpenTelemetry spans from a session log (turn / step / tool execute). Export only.
- npm：`dsh-otel@0.0.2`（2 个版本）
- 周下载：**27**
- 最近 push 2026-09-01
