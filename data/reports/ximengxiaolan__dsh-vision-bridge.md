...
> ximengxiaolan/dsh-vision-bridge · 第 1 期（数据快照 2026-09-14）
...
- ★3 · Composer-attached images are auto-described by an OpenAI-compatible vision model and handed to text-only models (DeepSeek) as text. ???????????
