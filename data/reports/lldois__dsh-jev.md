...
> lldois/dsh-jev · 第 1 期（数据快照 2026-09-21）
...
- ★0 · TypeSafe Jev System One semantic tool routing and typed decisions for DeepSeek Harness (DSH)
- npm：`dsh-jev@0.1.0`（1 个版本）
- 周下载：**158**
- 最近 push 2026-09-19
