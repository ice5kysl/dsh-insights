...
> MoFeng2223/dsh-claude-provider · 第 1 期（数据快照 2026-09-21）
...
- ★30 · Custom Claude provider support for DeepSeek Harness
- npm：`@mofeng2223/dsh-claude-provider@0.4.6`（12 个版本）
- 周下载：**250**
- 最近 push 2026-09-18

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「为DeepSeek Harness添加自定义Claude提供商支持。」。
