...
> hajimimaodie8/DSH-Session-Sync · 第 1 期（数据快照 2026-09-06）
...
- ★1 · Synchronize sessions, presets and settings between DSH desktop‑shell embedded instance and external web browser instance. Fix session isolation issue for third‑
...
```text
Add hajimimaodie8/DSH-Session-Sync to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-session-sync@0.2.6.
```
