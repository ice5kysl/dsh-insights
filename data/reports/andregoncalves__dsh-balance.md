...
> andregoncalves/dsh-balance · 第 1 期（数据快照 2026-09-15）
...
- ★0 · Provider-aware balance chip for the DeepSeek Harness web sidebar: DeepSeek, OpenRouter, Moonshot/Kimi, Zhipu/GLM, MiniMax. Lightweight, zero runtime deps, no co
- npm：`@andrecgoncalves/dsh-balance@0.4.1`（2 个版本）
- 周下载：**325**
- 最近 push 2026-09-09
