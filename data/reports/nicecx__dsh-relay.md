...
> nicecx/dsh-relay · 第 1 期（数据快照 2026-09-11）
...
- ★3 · DSH plugin: relay approval & question requests to any chat channel — iMessage, Email, WeChat built-in; Telegram/DingTalk/Feishu/Slack via a common adapter contr
