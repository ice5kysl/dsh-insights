...
> Frog755/dsh-prompt-vault · 第 1 期（数据快照 2026-09-21）
...
- npm：`@frog755/dsh-prompt-vault@1.0.2`（3 个版本）
- 周下载：**99**
- 最近 push 2026-09-10

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、npm 版本同步、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「输入框上方提示词库，📚按钮展开面板，点击条目一键填入 prompt。」。
