...
> haimuhaimu/dsh-image-gen · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DeepSeek Harness plugin: generate images via Aliyun Bailian Qwen-Image (bl CLI). Adds a generate_image tool returning images as conversation attachments.
