...
> stuarthu/dsh-update-notifier · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Hourly checks npm for newer versions of your installed dsh plugins and pops an approval bubble asking which to upgrade
