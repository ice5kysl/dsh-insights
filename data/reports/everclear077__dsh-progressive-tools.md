...
> everclear077/dsh-progressive-tools · 第 1 期（数据快照 2026-09-21）
...
- ★6 · Progressive tool discovery for DeepSeek Harness — tiny stable surface, searchable catalog, real pipeline execution, context cache intact.
