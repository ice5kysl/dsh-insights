...
> qknc-bot/dsh-opencode-go-usage · 第 1 期（数据快照 2026-09-06）
...
```text
Add qknc-bot/dsh-opencode-go-usage to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-opencode-go-usage@1.2.3.
```
