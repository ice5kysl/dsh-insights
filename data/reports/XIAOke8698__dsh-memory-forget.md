...
> XIAOke8698/dsh-memory-forget · 第 1 期（数据快照 2026-09-14）
...
- ★1 · Forgetting engine for AI agents — memory TTL, decay, eviction, audit. The opposite of memory programming. DSH plugin + local skill + CLI.
- npm：`@xiaoke8698/dsh-memory-forget@0.2.1`（3 个版本）
- 周下载：**16**
- 最近 push 2026-08-25
