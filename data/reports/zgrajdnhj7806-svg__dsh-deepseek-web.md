...
> zgrajdnhj7806-svg/dsh-deepseek-web · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DSH 插件：把 chat.deepseek.com 网页版接进 DeepSeek Harness（deepseek_web_ask / deepseek_web_analyze_lines / deepseek_web_status + 一键登录面板）。纯 Node，MIT License。
