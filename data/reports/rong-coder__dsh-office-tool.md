...
> rong-coder/dsh-office-tool · 第 1 期（数据快照 2026-09-21）
...
- ★5 · dsh plugin for DeepSeek Harness: complete Office document tools for the agent (create/read/edit .docx/.xlsx/.pptx via OfficeCLI) plus high-fidelity document pre
- npm：尚未发布
- 最近 push 2026-08-17
