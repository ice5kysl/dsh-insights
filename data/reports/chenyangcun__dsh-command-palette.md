...
> chenyangcun/dsh-command-palette · 第 1 期（数据快照 2026-09-21）
...
- ★0 · A keyboard-first command palette for standard DeepSeek Harness
- npm：`dsh-command-palette@0.1.5`（6 个版本）
- 周下载：**47**
- 最近 push 2026-08-30
