...
> jkrandom-sudo/dsh-plugin-audit · 第 1 期（数据快照 2026-09-21）
...
- ★4 · Security audit for DeepSeek Harness plugins: static permission profile with file/line evidence + a runtime sentinel gating credential access and unknown-host eg
