...
> didclawapp-ai/DSH-Office · 第 1 期（数据快照 2026-09-06）
...
- ★6 · DeepSeek Harness plugin for PPTX / DOCX / XLSX / PDF read/write/edit
- npm：尚未发布
...
```text
Add didclawapp-ai/DSH-Office to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
