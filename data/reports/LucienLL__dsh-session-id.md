...
> LucienLL/dsh-session-id · 第 1 期（数据快照 2026-09-14）
...
- ★0 · Show and copy the current session ID in the DeepSeek Harness web UI header
- npm：`dsh-session-id@0.1.1`（2 个版本）
- 周下载：**47**
- 最近 push 2026-08-26
