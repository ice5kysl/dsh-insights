...
> songqikong/dash · 第 1 期（数据快照 2026-09-06）
...
- ★3 · DASH — Deepseek Agentic Service Harness, a TUI Plugin of Deepseek Harness
- npm：尚未发布
...
```text
Add songqikong/dash to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
