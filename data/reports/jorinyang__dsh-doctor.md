...
> jorinyang/dsh-doctor · 第 1 期（数据快照 2026-09-11）
...
- ★3 · DeepSeek Harness environment diagnostic tool: dsh_doctor checks env, profile, config, bundles, mount, port, health, and disk
