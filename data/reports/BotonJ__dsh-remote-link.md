...
> BotonJ/dsh-remote-link · 第 1 期（数据快照 2026-09-15）
...
以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「认证远程网关：QR/HMAC配对、cookie会话、mDNS及fork_session工具，零依赖。」。
