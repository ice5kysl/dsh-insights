...
> kingOfSoySauce/dsh-liang-skin · 第 1 期（数据快照 2026-09-21）
...
- ★211 · DeepSeek Harness 滑动变阻器皮肤
- npm：`dsh-client-liang-intensity-skin@0.1.6`（1 个版本）
- 周下载：**906**
- 最近 push 2026-08-21

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、中文/双语文档、dsh-plugin topic、已度过新仓观察期；按 README 解读，主要能力是「DeepSeek Harness 的滑动变阻器风格皮肤。」。
