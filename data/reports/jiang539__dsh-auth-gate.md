...
> jiang539/dsh-auth-gate · 第 1 期（数据快照 2026-09-06）
...
```text
Add jiang539/dsh-auth-gate to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-auth-gate@0.12.0.
```
