...
> zhengmz/dsh-auto-fold · 第 1 期（数据快照 2026-09-21）
...
- ★2 · 补齐 DSH 在对话显示设为 Compact（紧凑）时无法自动折叠的能力。 Fills in the missing capability for DSH to auto-fold when the conversation display is set to Compact. 
- npm：尚未发布
- 最近 push 2026-09-17
