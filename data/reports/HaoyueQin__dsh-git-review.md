...
> HaoyueQin/dsh-git-review · 第 1 期（数据快照 2026-09-15）
...
- ★0 · DSH Git Review — 审查标签页 + 围栏 Git 工作台 | Review tab + fenced git workbench for DeepSeek Harness: file tree, diffs, lane graph, guarded git ops
- npm：`dsh-git-review@0.1.5`（5 个版本）
- 周下载：**661**
- 最近 push 2026-09-13
