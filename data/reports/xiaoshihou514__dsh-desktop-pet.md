...
> xiaoshihou514/dsh-desktop-pet · 第 1 期（数据快照 2026-09-21）
...
- ★36 · DeepSeek Harness：鲸鱼娘桌宠！
- npm：`dsh-desktop-pet@0.2.0`（2 个版本）
- 周下载：**243**
- 最近 push 2026-08-21

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期；按 README 解读，主要能力是「DSH鲸鱼娘桌宠，在桌面显示角色动画。」。
