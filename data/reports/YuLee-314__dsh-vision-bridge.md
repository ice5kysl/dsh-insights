...
> YuLee-314/dsh-vision-bridge · 第 1 期（数据快照 2026-09-21）
...
- ★1 · DeepSeek Harness 视觉补全：孪生路由解锁原生图片体验，本地 Ollama 请求层看图，零云端依赖。Vision twin + local agentic vision tools for DeepSeek Harness.
- npm：`@yulee-314/dsh-vision-bridge@2.0.0`（1 个版本）
- 周下载：**12**
- 最近 push 2026-08-16
