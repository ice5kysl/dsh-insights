...
> YuLee-314/dsh-vision-bridge · 第 1 期（数据快照 2026-09-06）
...
```text
Add YuLee-314/dsh-vision-bridge to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @yulee-314/dsh-vision-bridge@2.0.0.
```
