...
> dundunhan/dsh-video-lens · 第 1 期（数据快照 2026-09-21）
...
- ★114 · （无描述）
- npm：`dsh-video-lens@0.3.2`（2 个版本）
- 周下载：**301**
- 最近 push 2026-09-19

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「仅提供仓库名，没有插件描述，无法进行能力分析。」。
