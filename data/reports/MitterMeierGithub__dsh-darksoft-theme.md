...
> MitterMeierGithub/dsh-darksoft-theme · 第 1 期（数据快照 2026-09-21）
...
以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic；按 README 解读，主要能力是「DeepSeek Harness 网页深色主题插件，提供柔和彩色的标题与上下文样式。」。
