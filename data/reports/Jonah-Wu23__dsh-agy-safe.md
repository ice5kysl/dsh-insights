...
> Jonah-Wu23/dsh-agy-safe · 第 1 期（数据快照 2026-09-21）
...
- ★9 · DeepSeek Harness plugin: connect logged-in Antigravity CLI (agy) as chat and subagent model provider
- npm：`dsh-agy-safe@0.1.8`（9 个版本）
- 周下载：**160**
- 最近 push 2026-09-08
