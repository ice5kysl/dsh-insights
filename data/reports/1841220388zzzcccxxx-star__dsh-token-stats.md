...
> 1841220388zzzcccxxx-star/dsh-token-stats · 第 1 期（数据快照 2026-09-14）
...
- ★2 · Token usage & cost statistics plugin for DeepSeek Harness — per model / date / session, cost estimation (USD/CNY), CSV/JSON export | DeepSeek Harness Token 用量统计
