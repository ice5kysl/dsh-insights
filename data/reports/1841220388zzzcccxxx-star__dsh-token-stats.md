...
> 1841220388zzzcccxxx-star/dsh-token-stats · 第 1 期（数据快照 2026-09-06）
...
- ★3 · Token usage & cost statistics plugin for DeepSeek Harness — per model / date / session, cost estimation (USD/CNY), CSV/JSON export | DeepSeek Harness Token 用量统计
...
```text
Add 1841220388zzzcccxxx-star/dsh-token-stats to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-token-stats@0.2.0.
```
