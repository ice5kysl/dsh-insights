...
> protoctistmoses143/dsh-docs · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Convert PDFs, Office docs, scanned images, and more to clean Markdown, JSON, or text locally with offline OCR—no servers, no API keys, fully private.
