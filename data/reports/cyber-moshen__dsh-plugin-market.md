...
> cyber-moshen/dsh-plugin-market · 第 1 期（数据快照 2026-09-06）
...
```text
Add cyber-moshen/dsh-plugin-market to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @cyber-moshen/dsh-plugin-market@0.3.0.
```
