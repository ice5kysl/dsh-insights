...
> SYMlp/dsh-markdown-memory · 第 1 期（数据快照 2026-09-14）
...
- ★1 · Markdown folder long-term memory plugin for DeepSeek Harness (dsh): one file per fact, human-editable, git-versionable
