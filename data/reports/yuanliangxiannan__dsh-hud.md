...
> yuanliangxiannan/dsh-hud · 第 1 期（数据快照 2026-09-06）
...
- ★1 · Game-style HP / MP / TIME HUD for DeepSeek Harness.
...
```text
Add yuanliangxiannan/dsh-hud to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-hud@0.1.0.
```
