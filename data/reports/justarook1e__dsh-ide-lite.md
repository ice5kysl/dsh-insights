...
> justarook1e/dsh-ide-lite · 第 1 期（数据快照 2026-09-14）
...
- ★0 · Lightweight IDE-in-the-sidebar plugin for the dsh web GUI: workspace file tree, agent-change review (accept/reject + undo), full editing with diff and rendered 
- npm：`@justarook1e/dsh-ide-lite@1.32.2`（4 个版本）
- 周下载：**0**
- 最近 push 2026-09-13
