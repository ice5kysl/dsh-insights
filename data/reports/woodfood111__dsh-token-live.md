...
> woodfood111/dsh-token-live · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Composer readouts for the DeepSeek Harness: CJK-weighted draft token count, session spend at official peak/idle rates, context occupancy, and what the same usag
- npm：`dsh-token-live@0.1.0`（1 个版本）
- 周下载：**54**
- 最近 push 2026-09-15
