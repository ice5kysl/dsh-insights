...
> dongsheng123132/dsh-cost · 第 1 期（数据快照 2026-09-06）
...
```text
Add dongsheng123132/dsh-cost to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-cost@0.2.1.
```
