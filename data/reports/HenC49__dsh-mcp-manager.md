...
> HenC49/dsh-mcp-manager · 第 1 期（数据快照 2026-09-06）
...
```text
Add HenC49/dsh-mcp-manager to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-mcp-manager@0.6.0.
```
