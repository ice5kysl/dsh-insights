...
> dingminhua/dsh-connect-workbuddy · 第 1 期（数据快照 2026-09-15）
...
- ★18 · Connect locally signed-in WorkBuddy models to DeepSeek Harness with a read-only credits overview and model management.
- npm：`dsh-connect-workbuddy@1.1.3`（6 个版本）
- 周下载：**672**
- 最近 push 2026-09-11
