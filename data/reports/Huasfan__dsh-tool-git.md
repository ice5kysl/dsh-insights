...
> Huasfan/dsh-tool-git · 第 1 期（数据快照 2026-09-06）
...
- ★2 · Git tools for DeepSeek Harness agent
...
```text
Add Huasfan/dsh-tool-git to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-tool-git@0.1.3.
```
