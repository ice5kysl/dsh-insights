...
> kyya/dsh-deepseek-balance · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DeepSeek Harness plugin: real-time DeepSeek API balance in the sidebar
...
```text
Add kyya/dsh-deepseek-balance to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-deepseek-balance@0.1.0.
```
