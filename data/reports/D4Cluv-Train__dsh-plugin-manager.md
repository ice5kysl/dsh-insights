...
> D4Cluv-Train/dsh-plugin-manager · 第 1 期（数据快照 2026-09-06）
...
```text
Add D4Cluv-Train/dsh-plugin-manager to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @d4cluvtrain/dsh-plugin-manager@0.1.2.
```
