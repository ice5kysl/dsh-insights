...
> Olalaye/dsh-layered-memory · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DeepSeek Harness 分层长期记忆插件：瞬时/情景/语义三层记忆，自动捕获、AI 提炼、跨会话召回与可视化管理。
...
```text
Add Olalaye/dsh-layered-memory to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-layered-memory@0.9.2.
```
