...
> Max-Null/dsh-guardian · 第 1 期（数据快照 2026-09-14）
...
- ★1 · Event-driven mission guardian for DeepSeek Harness: assertion rules, correction detection, review queue · 事件驱动的任务守护：断言规则、纠正检测、编辑审查队列
- npm：`@max-null/dsh-guardian@0.2.0`（2 个版本）
- 周下载：**118**
- 最近 push 2026-09-12
