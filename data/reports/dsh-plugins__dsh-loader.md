...
> dsh-plugins/dsh-loader · 第 1 期（数据快照 2026-09-14）
...
- ★4 · A version‑aware adapter registry that decouples third‑party Cordis plugins from dsh’s internal service names, paths, and RPC internals. 基于版本感知适配器注册表，为 dsh Cordi
- npm：`@dsh-plugin/dsh-loader@1.3.4`（20 个版本）
- 周下载：**856**
- 最近 push 2026-09-07
