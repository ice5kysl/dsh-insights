...
> fan56/dsh-mcp-adapter · 第 1 期（数据快照 2026-09-21）
...
- ★1 · dsh plugin: fold mcp__* tool schemas into two meta-tools via prompt-side shim to save tokens
- npm：`@aiwayds/dsh-mcp-adapter@0.4.2`（9 个版本）
- 周下载：**345**
- 最近 push 2026-09-20
