...
> Uknown-wang/dsh-approval-notify · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Windows toast + sound notifications for DeepSeek Harness elevation approvals
- npm：`dsh-approval-notify@1.0.0`（1 个版本）
- 周下载：**49**
- 最近 push 2026-08-18
