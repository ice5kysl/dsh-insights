...
> nishuoyang/dsh-workbench-ecs · 第 1 期（数据快照 2026-09-14）
...
- ★1 · Alibaba Cloud Workbench CLI plugin — lets DeepSeek Harness's Agent directly control remote ECS instances.
- npm：`dsh-workbench-ecs@0.3.5`（9 个版本）
- 周下载：**225**
- 最近 push 2026-09-12
