...
> frozo-ai/dsh-budget · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Spend enforcement for DeepSeek Harness: hard budget caps, auto-downgrade, chargeback. Blocks over-budget calls before they are billed.
- npm：`dsh-cost-gate@0.2.0`（2 个版本）
- 周下载：**48**
- 最近 push 2026-08-19
