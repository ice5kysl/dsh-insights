...
> oil-oil/dsh-oil-sticky-prompt · 第 1 期（数据快照 2026-09-21）
...
- ★53 · Pin the nearest user prompt to the top of a DeepSeek Harness transcript
- npm：尚未发布
- 周下载：**0**
- 最近 push 2026-08-16

以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、LICENSE、已度过新仓观察期；按 README 解读，主要能力是「将最近的用户提示固定到DeepSeek Harness转录顶部」。
