...
> Ycet/dsh-archive-manager · 第 1 期（数据快照 2026-09-06）
...
**本期概览：B（79/100）· 在「侧栏 / 工作区」类 280 个插件里超过 25% 的同类（同类中位 85）**
...
```text
Add Ycet/dsh-archive-manager to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-archive-manager@1.1.1.
```
