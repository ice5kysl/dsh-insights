...
> 173787247/dsh-wsl-dns · 第 1 期（数据快照 2026-09-21）
...
以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic；按 README 解读，主要能力是「比较 WSL 与 Windows 对常见端点的 DNS 解析结果。」。
