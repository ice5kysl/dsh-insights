...
> chromoany/dsh-notify-me · 第 1 期（数据快照 2026-09-21）
...
- ★4 · DSH desktop reminder plugin: notify when the agent needs your input or a reply finishes
- npm：`dsh-notify-me@1.1.5`（7 个版本）
- 周下载：**657**
- 最近 push 2026-09-15
