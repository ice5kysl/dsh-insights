...
> Cheng-xiu/dsh-mobile-link · 第 1 期（数据快照 2026-09-15）
...
- ★2 · One-click phone access to DeepSeek Harness (DSH): Cloudflare quick tunnel + multi-channel push (ServerChan/PushPlus/Bark/ntfy/custom webhook).
- npm：尚未发布
- 最近 push 2026-08-23
