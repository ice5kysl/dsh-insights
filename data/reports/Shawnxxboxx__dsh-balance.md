...
> Shawnxxboxx/dsh-balance · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DSH plugin: show DeepSeek account balance below the conversation · 在对话下方显示 DeepSeek 账户余额
...
```text
Add Shawnxxboxx/dsh-balance to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-balance-dock@0.1.1.
```
