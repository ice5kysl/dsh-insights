...
> softspark/dsh-file-preview · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Read-only in-conversation file preview for DeepSeek Harness: a session-authorized host Remote and a sanitizing browser modal, installed as one profile bundle.
- npm：`@softspark/dsh-file-preview@2.0.0`（2 个版本）
- 周下载：**95**
- 最近 push 2026-09-11
