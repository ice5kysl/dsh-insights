...
> Zalpha263/dsh-file-explorer · 第 1 期（数据快照 2026-09-06）
...
```text
Add Zalpha263/dsh-file-explorer to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-file-explorer@0.1.1.
```
