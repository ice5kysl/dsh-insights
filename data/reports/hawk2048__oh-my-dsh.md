...
> hawk2048/oh-my-dsh · 第 1 期（数据快照 2026-09-21）
...
- ★0 · oh-my-dsh: OMC-style multi-agent orchestration for DeepSeek Harness — 29 workflow skills + 12 /omd-* slash commands, one-command bundle install + agent preset.
- npm：`@hawk2048/oh-my-dsh@0.2.1`（2 个版本）
- 周下载：**62**
- 最近 push 2026-09-16
