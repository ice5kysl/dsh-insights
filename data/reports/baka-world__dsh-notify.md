...
> baka-world/dsh-notify · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DeepSeek Harness desktop notification plugin (notify-send / D-Bus)
...
```text
Add baka-world/dsh-notify to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-notify@0.1.6.
```
