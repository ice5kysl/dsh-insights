...
> xjwwjx/dsh-sonic · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Sound notification plugin for DeepSeek Harness Web: plays a chime when user confirmation is needed and a success sound when tasks complete
- npm：尚未发布
- 最近 push 2026-08-17
