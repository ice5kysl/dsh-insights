...
> mrpulor-gh/dsh-nuphus-mcp · 第 1 期（数据快照 2026-09-15）
...
- ★5 · DeepSeek Harness (DSH) plugin: mount the nuphus-mcp desktop automation MCP server as native tools (mcp__nuphus-mcp__*).
