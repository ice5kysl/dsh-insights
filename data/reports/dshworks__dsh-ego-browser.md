...
> dshworks/dsh-ego-browser · 第 1 期（数据快照 2026-09-21）
...
- ★1 · ego lite browser automation for dsh that remembers — recall a site's learned tools, promote a working script into a new one, hand the user the keyboard for real
- npm：`@dshworks/dsh-ego-browser@0.1.1`（2 个版本）
- 周下载：**219**
- 最近 push 2026-09-18
