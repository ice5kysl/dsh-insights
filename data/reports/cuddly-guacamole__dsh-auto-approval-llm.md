...
> cuddly-guacamole/dsh-auto-approval-llm · 第 1 期（数据快照 2026-09-15）
...
- ★7 · LLM-assisted auto approval + timeout fallback for the DeepSeek Harness Auto preset
- npm：`@quill507/dsh-auto-approval-llm@0.0.18`（16 个版本）
- 周下载：**1503**
- 最近 push 2026-09-14
