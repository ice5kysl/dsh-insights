...
> zoahdev/dsh-browser-use · 第 1 期（数据快照 2026-09-15）
...
- ★2 · Browser Use bridge for DeepSeek Harness: run real web tasks (open pages, click, type, fill forms, extract data) through the Browser Use Cloud API.
