...
> Chu-m/dsh-chat-continue · 第 1 期（数据快照 2026-09-21）
...
- npm：`@wuxjs/dsh-chat-continue@1.2.1`（4 个版本）
- 周下载：**49**
- 最近 push 2026-08-24

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「自动重试失败的 API 请求，保持对话不中断，并支持自定义状态码和错误码。」。
