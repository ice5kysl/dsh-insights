...
> hkkz9522/dsh-session-manager · 第 1 期（数据快照 2026-09-06）
...
- ★5 · Session manager for the DeepSeek Harness Web UI: delete sessions, move sessions across workspaces, and migrate a session's Agent preset.
...
```text
Add hkkz9522/dsh-session-manager to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-session-manager@0.4.4.
```
