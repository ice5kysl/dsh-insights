...
> Yinxe/dsh-token-stats · 第 1 期（数据快照 2026-09-11）
...
- ★0 · DeepSeek Harness (DSH) token usage statistics plugin: aggregates all local session logs into cumulative/peak/streak stats, daily & weekly trends, hour-of-day di
- npm：尚未发布
- 最近 push 2026-09-04
