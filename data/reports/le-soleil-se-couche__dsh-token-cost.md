...
> le-soleil-se-couche/dsh-token-cost · 第 1 期（数据快照 2026-09-06）
...
```text
Add le-soleil-se-couche/dsh-token-cost to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
