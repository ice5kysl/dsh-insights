...
> MrMu666/dsh-LAN · 第 1 期（数据快照 2026-09-06）
...
- ★8 · 为DeepSeek  harness开启局域网访问及移动端页面的插件，移动端界面适配
- npm：尚未发布
...
```text
Add MrMu666/dsh-LAN to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
