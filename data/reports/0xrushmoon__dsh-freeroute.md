...
> 0xrushmoon/dsh-freeroute · 第 1 期（数据快照 2026-09-14）
...
- ★1 · Free-tier model aggregation plugin for the DeepSeek Harness (dsh): transparent failover, multi-key rotation, settings panel
- npm：`dsh-freeroute@0.8.4`（13 个版本）
- 周下载：**1520**
- 最近 push 2026-08-27
