...
> eons2long/dsh-codex-oauth · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DeepSeek Harness plugin for using ChatGPT Plus/Pro Codex models through OpenAI Codex OAuth.
...
```text
Add eons2long/dsh-codex-oauth to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-codex-oauth@0.2.8.
```
