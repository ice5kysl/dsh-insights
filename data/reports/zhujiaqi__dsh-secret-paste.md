...
> zhujiaqi/dsh-secret-paste · 第 1 期（数据快照 2026-09-21）
...
- ★3 · DeepSeek Harness plugin: detect pasted secrets, store them in the credentials seam, and send [secret:REF] placeholders to the model.
