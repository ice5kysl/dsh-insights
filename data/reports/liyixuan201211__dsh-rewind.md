...
> liyixuan201211/dsh-rewind · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Undo what an agent did to a directory: content-addressed snapshots, one-command rewind, and an undo you can undo. Works in any folder — git or not. DSH plugin +
