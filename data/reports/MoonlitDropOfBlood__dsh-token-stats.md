...
> MoonlitDropOfBlood/dsh-token-stats · 第 1 期（数据快照 2026-09-21）
...
- ★3 · dsh的token消耗的统计插件
- npm：`@duke-dsh-plugins/dsh-token-stats@1.3.4`（5 个版本）
- 周下载：**259**
- 最近 push 2026-09-19

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「DSH的Token消耗统计插件，用于追踪和分析Token使用量。」。
