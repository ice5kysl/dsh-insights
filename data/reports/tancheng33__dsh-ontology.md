...
> tancheng33/dsh-ontology · 第 1 期（数据快照 2026-09-14）
...
- ★5 · A typed, inference-capable ontology (TBox + ABox) plugin for DeepSeek Harness — durable domain knowledge the agent declares, asserts against, and queries under 
