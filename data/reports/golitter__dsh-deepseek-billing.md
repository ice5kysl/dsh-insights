...
> golitter/dsh-deepseek-billing · 第 1 期（数据快照 2026-09-06）
...
- ★3 · 在 DSH 中查看 DeepSeek API 账户余额及计费信息
- npm：尚未发布
...
```text
Add golitter/dsh-deepseek-billing to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
