...
> lanbaolu/dsh-fail-soft · 第 1 期（数据快照 2026-09-14）
...
以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、中文/双语文档、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「未提供描述；从仓库名推测与失败软处理（优雅降级/fail-soft）相关。」。
