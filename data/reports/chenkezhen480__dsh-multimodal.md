...
> chenkezhen480/dsh-multimodal · 第 1 期（数据快照 2026-09-06）
...
```text
Add chenkezhen480/dsh-multimodal to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
