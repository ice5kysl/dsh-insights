...
> STARDUSTLC666/dsh-dingtalk · 第 1 期（数据快照 2026-09-21）
...
- ★3 · DeepSeek Harness 钉钉群机器人插件：dingtalk_notify/text/health 三工具，自定义机器人 webhook + HMAC 加签，手写签名实现、零运行时依赖；纯 Node 全平台。· DingTalk group-robot notifications for DeepSeek Ha
- npm：`dsh-dingtalk@0.2.1`（4 个版本）
- 周下载：**330**
- 最近 push 2026-09-12
