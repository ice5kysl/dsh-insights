...
> 21hbguo/dsh-mobile-ui · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DSH Web GUI 手机端 UI 适配插件：窄屏下全屏聊天布局（抽屉化侧栏/面板 + 顶部操作条 + 返回键退栈），桌面宽度零影响
- npm：尚未发布
...
```text
Add 21hbguo/dsh-mobile-ui to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
