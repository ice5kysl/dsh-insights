...
> Yan-Zero/dsh-remote-ssh · 第 1 期（数据快照 2026-09-06）
...
- ★8 · Use SSH hosts as transparent workspaces in DeepSeek Harness.
...
```text
Add Yan-Zero/dsh-remote-ssh to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-remote-ssh@0.2.4.
```
