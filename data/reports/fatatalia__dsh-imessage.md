...
> fatatalia/dsh-imessage · 第 1 期（数据快照 2026-09-06）
...
- ★1 · dsh iMessage 插件：监听/路由/自动回复/typing/已读回执，随 dsh web 启停
...
```text
Add fatatalia/dsh-imessage to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-imessage@0.2.0.
```
