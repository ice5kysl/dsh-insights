...
> Yicijiuhaobala/dsh-session-delete · 第 1 期（数据快照 2026-09-15）
...
- ★0 · Adds a "Delete session" item to the DSH session-row context menu (next to rename/fork/archive) — permanently removes session logs from disk, with live-session p
