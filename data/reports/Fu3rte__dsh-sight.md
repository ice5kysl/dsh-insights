...
> Fu3rte/dsh-sight · 第 1 期（数据快照 2026-09-14）
...
- ★3 · Plug-in vision for text-only DeepSeek Harness (dsh) models: built-in free/cheap VLM presets + multi-image batch analysis
