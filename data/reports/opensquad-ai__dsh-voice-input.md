...
> opensquad-ai/dsh-voice-input · 第 1 期（数据快照 2026-09-06）
...
```text
Add opensquad-ai/dsh-voice-input to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @opensquad/dsh-voice-input@0.3.3.
```
