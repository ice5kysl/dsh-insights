...
> V-dev-388/DSH-plugin-market · 第 1 期（数据快照 2026-09-06）
...
```text
Add V-dev-388/DSH-plugin-market to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
