...
> GeekRicardo/dsh-convmap · 第 1 期（数据快照 2026-09-21）
...
以下几项检查未发现问题（仅作记录）：产物布局规范、files 白名单、npm 版本同步、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期；按 README 解读，主要能力是「主对话区左缘渲染对话地图刻度，悬停预览摘要，点击跳转并加载未渲染轮次，当前轮自动高亮。」。
