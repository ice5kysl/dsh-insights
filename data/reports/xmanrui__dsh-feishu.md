...
> xmanrui/dsh-feishu · 第 1 期（数据快照 2026-09-06）
...
- ★10 · 通过扫码把飞书机器人接入DeepSeek Harness
- npm：尚未发布
...
```text
Add xmanrui/dsh-feishu to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
