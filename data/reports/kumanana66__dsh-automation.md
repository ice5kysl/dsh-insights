...
> kumanana66/dsh-automation · 第 1 期（数据快照 2026-09-21）
...
- ★0 · RPA-style scheduled web automation for DeepSeek Harness: record browser operations -> requirements doc -> LLM generates Python + Playwright -> schedule with run
- npm：`dsh-automation@0.2.0-alpha.0`（2 个版本）
- 周下载：**84**
- 最近 push 2026-09-01
