...
> luoyu-xingu/dsh-background · 第 1 期（数据快照 2026-09-06）
...
- ★3 · DeepSeek Harness Web 背景图片插件:本地图片路径替换网页背景,外观设置行 + 实时预览
...
```text
Add luoyu-xingu/dsh-background to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-background@0.2.9.
```
