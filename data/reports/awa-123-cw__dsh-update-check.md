...
> awa-123-cw/dsh-update-check · 第 1 期（数据快照 2026-09-14）
...
- ★1 · DSH 设置页「关于」栏位 + 一键检测更新插件（About page with update checking for DeepSeek Harness WebUI）
- npm：`dsh-update-check@0.1.0`（1 个版本）
- 周下载：**39**
- 最近 push 2026-08-15
