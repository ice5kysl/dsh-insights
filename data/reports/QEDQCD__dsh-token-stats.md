...
> QEDQCD/dsh-token-stats · 第 1 期（数据快照 2026-09-06）
...
**做得好的**：产物布局规范、files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「统计 token 使用量的插件，暂无更多详细能力描述。」。这些是你的基本盘，保持即可。
...
**能力标签**：token-stats、usage、counting、analytics
...
```text
Add QEDQCD/dsh-token-stats to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
