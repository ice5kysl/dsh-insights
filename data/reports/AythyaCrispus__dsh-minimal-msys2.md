...
> AythyaCrispus/dsh-minimal-msys2 · 第 1 期（数据快照 2026-09-21）
...
- ★2 · Windows Minimal Mode: persistent bash + str_replace_editor dsh plugin — registers an agent preset, provides a working persistent-bash backend on Windows, and ex
- npm：尚未发布
- 最近 push 2026-08-15
