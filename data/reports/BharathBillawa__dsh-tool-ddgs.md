...
> BharathBillawa/dsh-tool-ddgs · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DuckDuckGo web search and URL fetch tools for DeepSeek Harness, no API key required. Provides web_search (via ddgs) and   web_fetch (via trafilatura) as a drop-
- npm：尚未发布
- 最近 push 2026-08-22
