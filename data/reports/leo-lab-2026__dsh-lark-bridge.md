...
> leo-lab-2026/dsh-lark-bridge · 第 1 期（数据快照 2026-09-06）
...
```text
Add leo-lab-2026/dsh-lark-bridge to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-lark-bridge@0.1.0.
```
