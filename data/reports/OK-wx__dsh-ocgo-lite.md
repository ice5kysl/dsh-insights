...
> OK-wx/dsh-ocgo-lite · 第 1 期（数据快照 2026-09-21）
...
以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期；按 README 解读，主要能力是「OpenCode Go用量条：余量环，token与花费实时统计，复制API Key。」。
