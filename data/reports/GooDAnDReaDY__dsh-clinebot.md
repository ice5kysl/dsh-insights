...
> GooDAnDReaDY/dsh-clinebot · 第 1 期（数据快照 2026-09-14）
...
- ★0 · DeepSeek Harness companion for ClineBot / ClinePass: dedicated settings page, live quota dashboard, in-UI key saving, curated & custom models, /cline command.
- npm：`@goodandready/dsh-clinebot@0.3.0`（3 个版本）
- 周下载：**950**
- 最近 push 2026-09-12
