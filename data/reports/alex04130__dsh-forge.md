...
> alex04130/dsh-forge · 第 1 期（数据快照 2026-09-06）
...
```text
Add alex04130/dsh-forge to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-forge@0.0.1.
```
