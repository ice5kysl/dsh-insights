...
> Beatther-c/dsh-api-client · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Agent-native API Client for DeepSeek Harness — Postman 级 API 调试 UI + Agent 原生 HTTP 工具 + Postman Collection 导入的 DSH 原生插件
