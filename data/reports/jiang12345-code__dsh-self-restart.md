...
> jiang12345-code/dsh-self-restart · 第 1 期（数据快照 2026-09-14）
...
- ★0 · DSH self-restart plugin (Windows): reliable elevated restart via schtasks, transparent front-end recovery, auto-detect and resume in-progress sessions across re
