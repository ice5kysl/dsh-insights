...
> sikadi233-hub/minecraft-dev · 第 1 期（数据快照 2026-09-21）
...
- ★16 · Minecraft development plugin for DeepSeek Harness: skills & tools for Paper/Spigot plugins and Fabric/Forge/NeoForge mods, MC 1.7.10-26.x
- npm：`minecraft-dev@0.7.2`（10 个版本）
- 周下载：**142**
- 最近 push 2026-09-10

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「面向 Minecraft 的开发技能与工具，覆盖 Paper/Spigot 插件及 Fabric/Forge/NeoForge 模组。」。
