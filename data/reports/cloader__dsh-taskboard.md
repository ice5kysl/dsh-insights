...
> cloader/dsh-taskboard · 第 1 期（数据快照 2026-09-06）
...
- ★34 · deepseekharness 任务看板插件 
- npm：`dsh-taskboard@0.6.4`（24 个版本）
- 最近 push 2026-09-04 · 收录：awesome — · imsai —

**做得好的**：产物布局规范、files 白名单、npm 已发布、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「DeepSeek Harness 任务看板插件，提供可视化任务管理能力。」。这些是你的基本盘，保持即可。
...
```text
Add cloader/dsh-taskboard to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-taskboard@0.6.4.
```
