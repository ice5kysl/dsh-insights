...
> sandbaseai/sandbase-harness · 第 1 期（数据快照 2026-09-14）
...
- ★644 · Local-first, self-hosted AI agent runtime and MCP bridge with sandboxed sessions, memory, credentials, audit/replay, and a local Console.
