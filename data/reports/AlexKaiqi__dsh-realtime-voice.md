...
> AlexKaiqi/dsh-realtime-voice · 第 1 期（数据快照 2026-09-11）
...
- ★1 · Full-duplex realtime voice-agent plugin for DeepSeek Harness, with OpenAI Realtime (WebRTC) and Doubao Duplex (WebSocket) adapters.
