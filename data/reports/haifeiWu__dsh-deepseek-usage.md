...
> haifeiWu/dsh-deepseek-usage · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DSH plugin: real-time DeepSeek token usage, estimated cost and account balance in the DSH Web UI
...
```text
Add haifeiWu/dsh-deepseek-usage to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-deepseek-usage@0.1.0.
```
