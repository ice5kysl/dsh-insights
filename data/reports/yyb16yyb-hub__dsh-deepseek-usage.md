...
> yyb16yyb-hub/dsh-deepseek-usage · 第 1 期（数据快照 2026-09-11）
...
- ★3 · Real-time DeepSeek API usage for DeepSeek Harness: balance, token stats, estimated cost — Web UI dock + settings panel + model tool.
