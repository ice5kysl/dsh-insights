...
> xiaoqiezi-china/dsh-music-player · 第 1 期（数据快照 2026-09-06）
...
```text
Add xiaoqiezi-china/dsh-music-player to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-music-player@1.0.0.
```
