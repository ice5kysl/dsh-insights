...
> Yurzi/dsh-web-fetch-enhanced · 第 1 期（数据快照 2026-09-14）
...
- ★5 · Configurable non-public address allowlists for DeepSeek Harness web_fetch
- npm：`dsh-web-fetch-enhanced@0.0.4`（4 个版本）
- 周下载：**297**
- 最近 push 2026-09-11
