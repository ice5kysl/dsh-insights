...
> 02Muller25/dsh-api-balance · 第 1 期（数据快照 2026-09-06）
...
- ★9 · 安装在deepseek的插件，能够实时显示当前api的余额，30秒自动刷新一次
- npm：尚未发布
- 最近 push 2026-08-15 · 收录：awesome-dsh-plugin ✅ · imsai —

**做得好的**：client 导出齐备、files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「显示当前API余额，每30秒自动刷新一次。」。这些是你的基本盘，保持即可。
...
```text
Add 02Muller25/dsh-api-balance to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
