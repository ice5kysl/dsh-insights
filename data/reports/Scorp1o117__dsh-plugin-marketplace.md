...
> Scorp1o117/dsh-plugin-marketplace · 第 1 期（数据快照 2026-09-06）
...
```text
Add Scorp1o117/dsh-plugin-marketplace to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-plugin-marketplace@0.3.0.
```
