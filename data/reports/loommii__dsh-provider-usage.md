...
> loommii/dsh-provider-usage · 第 1 期（数据快照 2026-09-15）
...
- ★0 · DSH plugin: OpenCode Go 用量查询 - floating whale click dialog (M1)
- npm：`@loommii/dsh-provider-usage@0.11.0`（6 个版本）
- 周下载：**362**
- 最近 push 2026-09-14
