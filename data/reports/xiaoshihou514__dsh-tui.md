...
> xiaoshihou514/dsh-tui · 第 1 期（数据快照 2026-09-15）
...
- ★3 · DeepSeek Harness: TUI
- npm：`dsh-tui@0.2.19`（21 个版本）
- 周下载：**371**
- 最近 push 2026-08-22

以下几项检查未发现问题（仅作记录）：产物布局规范、files 白名单、npm 已发布、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「为DeepSeek Harness提供终端用户界面。」。
