...
> xiaoshihou514/dsh-tui · 第 1 期（数据快照 2026-09-06）
...
**做得好的**：产物布局规范、files 白名单、npm 已发布、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「为DeepSeek Harness提供终端用户界面。」。这些是你的基本盘，保持即可。
...
```text
Add xiaoshihou514/dsh-tui to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-tui@0.2.19.
```
