...
> Creakono/dsh-cost-meter · 第 1 期（数据快照 2026-09-06）
...
- ★2 · Automatically calculate the cost based on the configured price list. 自动按配置的价目表算价格花费。默认未启用峰谷价格，后续还请自行在配置页添加
...
```text
Add Creakono/dsh-cost-meter to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-cost-meter@1.7.10.
```
