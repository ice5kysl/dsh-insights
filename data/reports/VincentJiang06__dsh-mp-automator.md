...
> VincentJiang06/dsh-mp-automator · 第 1 期（数据快照 2026-09-14）
...
- ★0 · WeChat Mini Program automated testing for DeepSeek Harness (dsh) — selector-addressed actions, build-freshness gates, geometry-first assertions for text-only mo
