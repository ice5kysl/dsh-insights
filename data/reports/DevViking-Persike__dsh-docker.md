...
> DevViking-Persike/dsh-docker · 第 1 期（数据快照 2026-09-11）
...
- ★0 · DeepSeek Harness plugin: Docker container, image, log, and Compose tools for the agent, over the local Docker CLI
- npm：尚未发布
- 最近 push 2026-08-22
