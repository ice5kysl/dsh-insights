...
> cn-scuo-oo/dsh-deepseek-quota · 第 1 期（数据快照 2026-09-06）
...
```text
Add cn-scuo-oo/dsh-deepseek-quota to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-deepseek-quota@0.5.2.
```
