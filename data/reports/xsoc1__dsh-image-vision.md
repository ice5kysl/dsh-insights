...
> xsoc1/dsh-image-vision · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Eyes for text-only DeepSeek: view_image tool (local Ollama or any OpenAI-compatible VLM) + chat image-attachment bridge — paste/drop images in the chat and the 
- npm：尚未发布
- 最近 push 2026-08-15
