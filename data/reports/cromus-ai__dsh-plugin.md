...
> cromus-ai/dsh-plugin · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DeepSeek Harness bundle: score, validate, and cost-estimate AI skills with Cromus.
- npm：`@cromus-ai/dsh-plugin@1.0.0`（1 个版本）
- 周下载：**49**
- 最近 push 2026-08-16
