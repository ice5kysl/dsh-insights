...
> HR2AY/DSH-Plan-Graph · 第 1 期（数据快照 2026-09-21）
...
- ★16 · another version of deepseek herness trajectory (DIY)
- npm：尚未发布
- 最近 push 2026-08-16

以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期；按 README 解读，主要能力是「DeepSeek Harness轨迹的另一个DIY版本，以计划图形式展示。」。
