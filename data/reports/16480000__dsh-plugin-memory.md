...
> 16480000/dsh-plugin-memory · 第 1 期（数据快照 2026-09-06）
...
```text
Add 16480000/dsh-plugin-memory to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-plugin-memory@0.5.2.
```
