...
> zoahdev/dsh-cn-boot · 第 1 期（数据快照 2026-09-14）
...
- ★2 · China-network bootstrap for DeepSeek Harness (dsh): connectivity probes to npm/GitHub/HuggingFace/mirrors, local proxy detection, mirror recommendations, genera
