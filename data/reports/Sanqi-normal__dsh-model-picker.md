...
> Sanqi-normal/dsh-model-picker · 第 1 期（数据快照 2026-09-06）
...
- ★5 · 针对DSH web前端设计，对模型选择面板进行了升级，改为供应商-模型两侧滚动面板，并添加了搜索框
...
```text
Add Sanqi-normal/dsh-model-picker to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-model-picker@1.0.2.
```
