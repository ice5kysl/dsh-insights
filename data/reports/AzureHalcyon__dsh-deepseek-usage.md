...
> AzureHalcyon/dsh-deepseek-usage · 第 1 期（数据快照 2026-09-06）
...
**做得好的**：files 白名单、npm 已发布、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「DeepSeek余额/用量极简面板，无多余窗口，配置简单。」。这些是你的基本盘，保持即可。
...
```text
Add AzureHalcyon/dsh-deepseek-usage to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-deepseek-usage@0.1.0.
```
