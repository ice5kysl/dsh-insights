...
> scientisbo/dsh-deepseek-usage · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DeepSeek 用量 · 余额面板（DeepSeek Harness Web 客户端插件） | A clean DeepSeek usage & balance panel for DeepSeek Harness
