...
> chiro2001/dsh-dcp · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DeepSeek Harness 动态上下文管理插件（Dynamic Context Pruning for dsh），对标 opencode-dcp
- npm：尚未发布
...
```text
Add chiro2001/dsh-dcp to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
