...
> u9521/dsh-advanced-model-editor · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DSH WebUI plugin for managing custom LLM providers, model parameters, thinking budgets, and request settings.
- npm：尚未发布
- 最近 push 2026-09-10
