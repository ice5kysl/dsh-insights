...
> Scorp1o117/dsh-tool-vision · 第 1 期（数据快照 2026-09-06）
...
- ★7 · Vision model for DeepSeek Harness | DeepSeek Harness 外置视觉模型插件
- npm：`dsh-tool-vision@0.7.0`（19 个版本）
- 最近 push 2026-09-03 · 收录：awesome — · imsai —

**做得好的**：files 白名单、npm 已发布、npm 版本同步、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「DeepSeek Harness 外置视觉模型插件」。这些是你的基本盘，保持即可。
...
```text
Add Scorp1o117/dsh-tool-vision to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-tool-vision@0.7.0.
```
