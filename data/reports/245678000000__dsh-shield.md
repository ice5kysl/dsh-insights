...
> 245678000000/dsh-shield · 第 1 期（数据快照 2026-09-06）
...
```text
Add 245678000000/dsh-shield to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-shield@1.0.0.
```
