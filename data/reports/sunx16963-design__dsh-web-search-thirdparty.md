...
> sunx16963-design/dsh-web-search-thirdparty · 第 1 期（数据快照 2026-09-21）
...
- ★3 · A configurable third-party web-search plugin for DSH (DeepSeek Harness)/一个用于DSH（DeepSeek Harness）的可配置第三方网络搜索插件
