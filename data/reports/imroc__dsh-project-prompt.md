...
> imroc/dsh-project-prompt · 第 1 期（数据快照 2026-09-14）
...
- ★2 · Private, per-project prompt rules for DeepSeek Harness — matched by git remote/repo/path, worktree-aware, never committed to the repo
