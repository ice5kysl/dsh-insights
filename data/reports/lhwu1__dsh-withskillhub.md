...
> lhwu1/dsh-withskillhub · 第 1 期（数据快照 2026-09-21）
...
- ★5 · 携手skillhub，快捷安装启用丰富的skill，一键装配方便快捷。
- npm：尚未发布
- 最近 push 2026-08-17

以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期；按 README 解读，主要能力是「集成skillhub，一键安装并启用丰富技能，快捷方便。」。
