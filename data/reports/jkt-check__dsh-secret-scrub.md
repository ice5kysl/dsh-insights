...
> jkt-check/dsh-secret-scrub · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Irreversible secret-scrubbing guard plugin for DeepSeek Harness (dsh): regex redaction of secrets before session-log persistence and model requests
