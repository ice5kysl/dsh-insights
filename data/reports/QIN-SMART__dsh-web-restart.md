...
> QIN-SMART/dsh-web-restart · 第 1 期（数据快照 2026-09-06）
...
```text
Add QIN-SMART/dsh-web-restart to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-web-restart@undefined.
```
