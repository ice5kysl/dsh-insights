...
> Zenjibad/dsh-any-attachment · 第 1 期（数据快照 2026-09-21）
...
- ★2 · dsh bundle: attach any file type in the DeepSeek Harness Web UI — text-likes inline, binaries as workspace path references, rasters via the built-in pipeline
- npm：尚未发布
- 最近 push 2026-08-14
