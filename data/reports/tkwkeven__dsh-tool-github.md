...
> tkwkeven/dsh-tool-github · 第 1 期（数据快照 2026-09-14）
...
- ★0 · GitHub REST API tools and web GUI panel for DeepSeek Harness: bind account, search code/issues, manage PRs, clone workspaces
- npm：`dsh-tool-github@0.1.0`（1 个版本）
- 周下载：**54**
- 最近 push 2026-08-22
