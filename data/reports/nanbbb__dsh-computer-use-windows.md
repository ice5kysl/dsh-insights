...
> nanbbb/dsh-computer-use-windows · 第 1 期（数据快照 2026-09-14）
...
- ★1 · Windows Computer Use tools for DeepSeek Harness: self-contained UIA native helper, occlusion-aware screenshots, safety-gated input
