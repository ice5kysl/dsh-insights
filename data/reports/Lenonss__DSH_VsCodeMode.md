...
> Lenonss/DSH_VsCodeMode · 第 1 期（数据快照 2026-09-21）
...
- ★11 · deepseek-harness
- npm：`dsh-vscode-mode@0.4.6`（60 个版本）
- 周下载：**1651**
- 最近 push 2026-09-18

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「DSH的VS Code模式插件，可用描述信息极少」。
