...
> ZSeven-W/dsh-crew · 第 1 期（数据快照 2026-09-14）
...
- ★146 · DeepSeek Harness (DSH) plugin: dispatch work to DSH agents from Claude Code / Codex — native subagent progress, in-host worker sessions with per-tier presets, a
- npm：尚未发布
- 最近 push 2026-09-14
