...
> ZSeven-W/dsh-crew · 第 1 期（数据快照 2026-09-21）
...
- ★149 · DeepSeek Harness (DSH) plugin: dispatch work to DSH agents from Claude Code / Codex — native subagent progress, in-host worker sessions with per-tier presets, a
- npm：`@zseven-w/dsh-crew@0.1.0-rc.7`（10 个版本）
- 周下载：**551**
- 最近 push 2026-09-14

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「向DSH子代理分派工作；支持原生进度、分级工人会话与多模态视觉/图像生成。」。
