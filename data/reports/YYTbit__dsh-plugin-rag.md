...
> YYTbit/dsh-plugin-rag · 第 1 期（数据快照 2026-09-06）
...
- ★1 · Local knowledge base RAG for DeepSeek Harness
...
```text
Add YYTbit/dsh-plugin-rag to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-plugin-rag@0.1.1.
```
