...
> bailinghub/bailinghub-dsh-plugin · 第 1 期（数据快照 2026-09-14）
...
- ★1 · 让本地 DeepSeek Harness Agent 查询和操作你的商城、SaaS 或其他业务后台，原有权限与审计仍由 BailingHub 管理。Independent DSH integration for BailingHub.
- npm：`dsh-bailinghub@0.3.0`（4 个版本）
- 周下载：**265**
- 最近 push 2026-09-10
