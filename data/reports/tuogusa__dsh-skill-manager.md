...
> tuogusa/dsh-skill-manager · 第 1 期（数据快照 2026-09-06）
...
```text
Add tuogusa/dsh-skill-manager to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-skill-manager@0.1.3.
```
