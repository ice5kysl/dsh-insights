...
> bamboostrip/dsh-llm-capabilities · 第 1 期（数据快照 2026-09-21）
...
- ★1 · DSH plugin: auto-detect and configure model capabilities (reasoningEfforts + input modalities) for llm-pi-ai. Successor to dsh-reasoning-efforts.
