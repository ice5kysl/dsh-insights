...
> kittimzhe/dsh-session-export · 第 1 期（数据快照 2026-09-11）
...
- ★2 · Human-readable session transcript export for DeepSeek Harness — /transcript writes Markdown/JSON to a host path via ctx.sessionQuery (dsh-plugin)
