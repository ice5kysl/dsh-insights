...
> wanshichenguang/dsh-tool-vision · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DSH plugin: image_describe (识图) tool over the DashScope OpenAI-compatible vision API (qwen3.7-flash). Bring your own DASHSCOPE_API_KEY.
...
```text
Add wanshichenguang/dsh-tool-vision to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-tool-vision@0.7.0.
```
