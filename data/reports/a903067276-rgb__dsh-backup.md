...
> a903067276-rgb/dsh-backup · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Automated backups of DSH sessions, config and custom directories — scheduled or manual, packed as tgz with rotation
- npm：`dsh-backup@0.1.1`（1 个版本）
- 周下载：**30**
- 最近 push 2026-09-15
