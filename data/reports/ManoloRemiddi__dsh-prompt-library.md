...
> ManoloRemiddi/dsh-prompt-library · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Reusable prompts in DeepSeek Harness Settings, with standalone SQLite storage or an existing Augmentor service.
- npm：尚未发布
- 周下载：**0**
- 最近 push 2026-09-13
