...
> STARDUSTLC666/dsh-code-security · 第 1 期（数据快照 2026-09-21）
...
- ★1 · DSH AI 代码安全审查插件：十工具确定性扫描（40+ 规则、密钥熵检测、staged diff、SARIF 导出）、基线接受、SBOM-lite 依赖清单与健康自检，零运行时依赖。 已验证兼容 DeepSeek Harness v0.1.2-alpha.5。
- npm：`dsh-code-security@0.3.3`（6 个版本）
- 周下载：**382**
- 最近 push 2026-09-18
