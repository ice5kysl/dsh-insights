...
> lin-cheng-lab/dsh-plugin-doctor · 第 1 期（数据快照 2026-09-06）
...
- ★1 · DSH 插件体检：安装前检查 peer 版本兼容性，防止 rc 不匹配崩溃 🩺
...
```text
Add lin-cheng-lab/dsh-plugin-doctor to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-plugin-doctor@0.1.1.
```
