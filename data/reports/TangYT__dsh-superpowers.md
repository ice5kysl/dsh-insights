...
> TangYT/dsh-superpowers · 第 1 期（数据快照 2026-09-21）
...
- ★2 · DeepSeek Harness port of obra/superpowers: 14 agentic skills (brainstorming/planning/SDD/TDD/debugging/review/worktrees) + session-start bootstrap injection.
