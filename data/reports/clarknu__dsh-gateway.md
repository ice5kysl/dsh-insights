...
> clarknu/dsh-gateway · 第 1 期（数据快照 2026-09-15）
...
- ★5 · Self-contained HTTPS remote-access gateway for the DeepSeek Harness web surface — the Caddy layer as a dsh plugin.
- npm：`dsh-gateway@1.7.0`（17 个版本）
- 周下载：**166**
- 最近 push 2026-09-14
