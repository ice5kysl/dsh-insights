...
> hyzyn/dsh-plugin-kit · 第 1 期（数据快照 2026-09-21）
...
- ★20 · Plugin family for the DeepSeek Harness (DSH) Web GUI: a pnpm monorepo with a plugin template, dev kit, and one-command all-in-one bundle — Codegraph, env & secr
- npm：`@hyzyn/dsh-plugin-kit@0.1.24`（24 个版本）
- 周下载：**1562**
- 最近 push 2026-09-20
