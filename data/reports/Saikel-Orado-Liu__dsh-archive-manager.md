...
> Saikel-Orado-Liu/dsh-archive-manager · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Archived-session management (show/unarchive/permanently delete) for the DSH Web GUI, with zero changes to official packages.
- npm：`@gamegeek-saikel/dsh-archive-manager@0.2.0`（4 个版本）
- 周下载：**192**
- 最近 push 2026-09-16
