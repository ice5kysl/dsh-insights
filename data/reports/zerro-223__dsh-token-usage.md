...
> zerro-223/dsh-token-usage · 第 1 期（数据快照 2026-09-15）
...
- ★2 · Token usage statistics plugin for DeepSeek Harness (DSH) Web UI: per-request LLM usage captured from llm/stream, dual-axis trend charts, cache hit rate, API/mod
