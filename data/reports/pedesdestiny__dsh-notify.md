...
> pedesdestiny/dsh-notify · 第 1 期（数据快照 2026-09-14）
...
- ★2 · Browser desktop notifications for DeepSeek Harness (dsh) — get notified when a turn completes or an approval is needed
