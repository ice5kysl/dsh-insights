...
> KannaKuron/dsh-better-workspace · 第 1 期（数据快照 2026-09-14）
...
- ★4 · DSH web plugin: a hierarchical workspace tree for the sidebar — titles containing / group into virtual folders; the add-workspace flow gains a parent-group popu
- npm：`dsh-better-workspace@0.9.3`（12 个版本）
- 周下载：**474**
- 最近 push 2026-09-13

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、npm 版本同步、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「为DSH侧边栏提供层级工作区树；标题含/自动归入虚拟文件夹，新建工作区带父组选择弹窗。」。
