...
> maxmilian/dsh-forge · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DeepSeek Harness tools for self-hosted Gitea and Forgejo instances
- npm：`@maxhsu/dsh-forge@0.3.3`（1 个版本）
...
```text
Add maxmilian/dsh-forge to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @maxhsu/dsh-forge@0.3.3.
```
