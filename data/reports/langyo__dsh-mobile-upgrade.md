...
> langyo/dsh-mobile-upgrade · 第 1 期（数据快照 2026-09-15）
...
- ★1 · Mobile UI fixes for the DeepSeek Harness web profile: composer upload, restart row, narrow drawer and tabs, and a full-width model menu.
- npm：`dsh-mobile-upgrade@0.5.0`（10 个版本）
- 周下载：**2043**
- 最近 push 2026-09-12
