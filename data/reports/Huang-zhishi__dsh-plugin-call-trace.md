...
> Huang-zhishi/dsh-plugin-call-trace · 第 1 期（数据快照 2026-09-21）
...
以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic；按 README 解读，主要能力是「调用追踪插件，记录插件调用链，供调试与分析。」。
