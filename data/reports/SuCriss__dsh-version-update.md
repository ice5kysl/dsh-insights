...
> SuCriss/dsh-version-update · 第 1 期（数据快照 2026-09-14）
...
- ★3 · Version update menu for the DeepSeek Harness Web GUI settings panel: check @deepseek-ai/dsh releases, install one with a click, then restart the host and reload
- npm：`dsh-version-update@1.0.8`（6 个版本）
- 周下载：**871**
- 最近 push 2026-09-13
