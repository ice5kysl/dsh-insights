...
> ciceroyang/dsh-prompt-library · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DeepSeek Harness 常用指令库：一份写好中文提示词的清单，搜一下、点一下就能填进输入框，给不熟悉怎么写提示词的人用。
- npm：`dsh-prompt-library@undefined`（0 个版本）
- 周下载：**0**
- 最近 push 2026-09-17
