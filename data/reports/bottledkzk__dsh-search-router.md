...
> bottledkzk/dsh-search-router · 第 1 期（数据快照 2026-09-15）
...
- ★1 · DeepSeek Harness search router plugin: multi-provider web_search with live switching, status, and automatic fallback.
