...
> mrdevlorx/dsh-model-garden · 第 1 期（数据快照 2026-09-14）
...
- ★7 · A searchable, sortable model picker for the DeepSeek Harness Web UI — provider groups, favorites, models.dev prices, context windows, live per-task token cost a
- npm：`dsh-model-garden@0.6.3`（10 个版本）
- 周下载：**60**
- 最近 push 2026-08-27
