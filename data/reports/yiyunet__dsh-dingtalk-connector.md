...
> yiyunet/dsh-dingtalk-connector · 第 1 期（数据快照 2026-09-14）
...
- ★0 · 把钉钉 AI 表格接入 DeepSeek Harness ｜ 10 个工具 + 设置面板 + 定时导出 ｜ Read & write DingTalk AI Tables from DeepSeek Harness
