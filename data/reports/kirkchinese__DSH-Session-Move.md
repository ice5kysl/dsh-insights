...
> kirkchinese/DSH-Session-Move · 第 1 期（数据快照 2026-09-06）
...
```text
Add kirkchinese/DSH-Session-Move to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-session-move@0.1.1.
```
