...
> OPaimon/dsh-model-gate · 第 1 期（数据快照 2026-09-21）
...
- ★1 · （无描述）
- npm：`dsh-model-gate@0.1.3`（3 个版本）
- 周下载：**126**
- 最近 push 2026-08-23

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「名为dsh-model-gate的插件，推测为模型网关，暂无README细节。」。
