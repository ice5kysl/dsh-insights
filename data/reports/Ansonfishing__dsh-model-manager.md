...
> Ansonfishing/dsh-model-manager · 第 1 期（数据快照 2026-09-21）
...
以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「管理本地LLM推理服务：GPU登记、参数配置、VRAM校验、tok/s基准。」。
