...
> MkaliezZ/dsh-docs · 第 1 期（数据快照 2026-09-06）
...
- ★0 · Version-aware documentation query with excerpt bounding for DSH; host-supplied lookup, no hard-coded web provider.
- npm：`@mkaliezz/dsh-docs@0.2.2`（3 个版本）
...
```text
Add MkaliezZ/dsh-docs to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @mkaliezz/dsh-docs@0.2.2.
```
