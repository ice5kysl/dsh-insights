...
> yingjunnan/dsh-deepseek-quota · 第 1 期（数据快照 2026-09-21）
...
- ★3 · DeepSeek API quota (balance) widget for the DSH web GUI: a floating bottom-right card showing remaining DeepSeek API balance.
