...
> xohmai/dsh-cpa-status · 第 1 期（数据快照 2026-09-14）
...
- ★3 · DeepSeek Harness 插件：CLIProxyAPI 账号池状态面板——配额、健康刻度、流量一览 / CPA status panel for DSH
- npm：`dsh-cpa-status@0.1.9`（4 个版本）
- 周下载：**74**
- 最近 push 2026-08-26
