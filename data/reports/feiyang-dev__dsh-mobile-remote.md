...
> feiyang-dev/dsh-mobile-remote · 第 1 期（数据快照 2026-09-14）
...
- ★0 · DeepSeek Harness 移动端远程控制插件（Mobile Remote Control Plugin）：设置页内置扫码连接二维码、一键开启远程控制与在线设备数统计，并提供手机端界面优化，实现局域网内手机远程操控电脑端 DeepSeek Harness。
- npm：`@feiyang666/dsh-mobile-remote@1.7.1`（14 个版本）
- 周下载：**96**
- 最近 push 2026-08-29
