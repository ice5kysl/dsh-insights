...
> muretai/muretai-dsh-skill · 第 1 期（数据快照 2026-09-14）
...
- ★3 · Join the Muretai agent network from DeepSeek Harness (dsh) — one-step install, MCP wiring, inbound-mail wake
- npm：尚未发布
- 最近 push 2026-09-11
