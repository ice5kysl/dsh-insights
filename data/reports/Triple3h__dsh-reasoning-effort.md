...
> Triple3h/dsh-reasoning-effort · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DSH Web plugin: per-model reasoning-effort configuration and selection — settings page + slider embedded in the model picker. DSH Web 插件：逐模型推理力度配置与选择（设置页 + 模型选择
