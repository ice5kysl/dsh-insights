...
> UNLINEARITY/dsh-code · 第 1 期（数据快照 2026-09-15）
...
以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「类Claude Code的DSH TUI工具集，支持特殊模式、插件、模型/子代理管理及动画，1.0起自迭代。」。
