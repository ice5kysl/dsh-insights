...
> 1304836815/dsh-auto-memory · 第 1 期（数据快照 2026-09-06）
...
```text
Add 1304836815/dsh-auto-memory to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
