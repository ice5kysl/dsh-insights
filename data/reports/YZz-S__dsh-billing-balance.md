...
> YZz-S/dsh-billing-balance · 第 1 期（数据快照 2026-09-21）
...
- ★3 · Community plugins for DeepSeek Harness (DSH) Web GUI: token cost meter, billing balance, update checker — plain JavaScript, no build required.
- npm：尚未发布
- 最近 push 2026-09-19
