...
> eightHundreds/dsh-plannotator · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Review DeepSeek Harness plans in Plannotator — annotate, approve, or send them back.
- npm：`dsh-plannotator@0.2.0`（6 个版本）
- 周下载：**91**
- 最近 push 2026-08-19
