...
> huasheng33991/dsh-power-button · 第 1 期（数据快照 2026-09-11）
...
- ★3 · One-click start/stop (restart) button for DeepSeek Harness, pinned to the window bottom-right corner. / DSH 一键启停按钮。
- npm：尚未发布
- 最近 push 2026-08-16
