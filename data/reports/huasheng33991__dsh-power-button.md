...
> huasheng33991/dsh-power-button · 第 1 期（数据快照 2026-09-06）
...
```text
Add huasheng33991/dsh-power-button to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
