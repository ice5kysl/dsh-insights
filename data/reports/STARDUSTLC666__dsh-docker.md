...
> STARDUSTLC666/dsh-docker · 第 1 期（数据快照 2026-09-21）
...
- ★3 · DeepSeek Harness 容器管理插件：docker_ps/images/logs/inspect/exec/manage/health 七工具，官方 subprocess 服务、argv 无 shell 注入、exec 审批门、零运行时依赖。· Containers for DeepSeek Harness 
- npm：`@stardustlc/dsh-docker@0.3.3`（7 个版本）
- 周下载：**329**
- 最近 push 2026-09-18
