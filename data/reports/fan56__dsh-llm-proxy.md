...
> fan56/dsh-llm-proxy · 第 1 期（数据快照 2026-09-21）
...
- ★0 · dsh plugin: per-host LLM outbound HTTP proxy routing (undici ProxyAgent) with a bundled dsh skill
- npm：`@aiwayds/dsh-llm-proxy@0.5.0`（7 个版本）
- 周下载：**310**
- 最近 push 2026-09-12
