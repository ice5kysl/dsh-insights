...
> fan56/dsh-llm-proxy · 第 1 期（数据快照 2026-09-14）
...
- ★1 · dsh plugin: per-host LLM outbound HTTP proxy routing (undici ProxyAgent) with a bundled dsh skill
- npm：`@aiwayds/dsh-llm-proxy@0.4.1`（5 个版本）
- 周下载：**1027**
- 最近 push 2026-09-12
