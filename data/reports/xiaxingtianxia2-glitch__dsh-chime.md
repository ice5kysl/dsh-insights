...
> xiaxingtianxia2-glitch/dsh-chime · 第 1 期（数据快照 2026-09-14）
...
- ★4 · DSH 插件：opencode 任务完成提示音（完成/提问/错误三音，原始 mp3 内嵌，零依赖）。官方 bundle 插件，dsh plugin --profile web add: github:xiaxingtianxia2-glitch/dsh-chime#main
