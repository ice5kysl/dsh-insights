...
> citisen/dsh-font · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DeepSeek Harness plugin: customize the Web GUI fonts (interface font, code font, and font sizes) from Settings
- npm：`@citisen/dsh-font@0.1.0`（1 个版本）
- 周下载：**23**
- 最近 push 2026-09-20
