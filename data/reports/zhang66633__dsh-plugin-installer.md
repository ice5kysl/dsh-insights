...
> zhang66633/dsh-plugin-installer · 第 1 期（数据快照 2026-09-06）
...
- ★3 · DeepSeek Harness（dsh）的插件商店 + 安装助手：在 Web GUI 里逛插件目录，一键确认安装，agent 替你装好。
...
```text
Add zhang66633/dsh-plugin-installer to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-plugin-installer@2.0.1.
```
