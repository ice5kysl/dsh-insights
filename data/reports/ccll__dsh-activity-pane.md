...
> ccll/dsh-activity-pane · 第 1 期（数据快照 2026-09-14）
...
- ★0 · Activity session overview pane for DeepSeek Harness (DSH) web — running sessions, sub-agents, waiting-for-action reminders & recent history at a glance / DSH 活动
- npm：`dsh-activity-pane@0.4.0`（5 个版本）
- 周下载：**608**
- 最近 push 2026-09-11
