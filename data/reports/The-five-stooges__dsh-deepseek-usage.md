...
> The-five-stooges/dsh-deepseek-usage · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DSH plugin: DeepSeek balance row in the sidebar footer plus a popover with locally estimated usage charts and a per-model cost table
