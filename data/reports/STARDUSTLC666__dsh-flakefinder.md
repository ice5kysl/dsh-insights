...
> STARDUSTLC666/dsh-flakefinder · 第 1 期（数据快照 2026-09-21）
...
- ★1 · DSH 测试稳定性插件：六工具重复运行 vitest/jest/pytest/node:test 识别 flaky 用例，历史留档与隔离清单、健康自检，零运行时依赖。 已验证兼容 DeepSeek Harness v0.1.2-alpha.5。
- npm：`dsh-flakefinder@0.3.3`（8 个版本）
- 周下载：**335**
- 最近 push 2026-09-18
