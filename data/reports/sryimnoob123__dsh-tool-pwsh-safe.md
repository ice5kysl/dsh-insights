...
> sryimnoob123/dsh-tool-pwsh-safe · 第 1 期（数据快照 2026-09-14）
...
- ★1 · Elbow-proof PowerShell for DeepSeek Harness: pwsh_safe tool runs scripts via base64 -EncodedCommand, immune to quoting/escaping pain, sandbox-seam based
