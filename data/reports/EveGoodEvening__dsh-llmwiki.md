...
> EveGoodEvening/dsh-llmwiki · 第 1 期（数据快照 2026-09-06）
...
- ★1 · （无描述）
- npm：`@evegoodevening/dsh-llmwiki@0.1.3`（4 个版本）
...
```text
Add EveGoodEvening/dsh-llmwiki to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @evegoodevening/dsh-llmwiki@0.1.3.
```
