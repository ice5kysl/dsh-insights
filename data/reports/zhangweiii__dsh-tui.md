...
> zhangweiii/dsh-tui · 第 1 期（数据快照 2026-09-06）
...
- ★1 · （无描述）
- npm：`@zhangweiii/dsh-tui@0.3.1`（5 个版本）
...
```text
Add zhangweiii/dsh-tui to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @zhangweiii/dsh-tui@0.3.1.
```
