...
> 1na-ko/dsh-hdc-bridge · 第 1 期（数据快照 2026-09-14）
...
- ★17 · DSH 原生鸿蒙开发助手：hdc 设备闭环调试 + 设备面板（官方 client 插件形态）+ 离线官方知识层（Tier-1 随包）+ DevEco CLI 构建/签名/模拟器控制 / DSH-native HarmonyOS dev assistant: hdc device loop, live device pa
- npm：`dsh-hdc-bridge@0.9.0`（16 个版本）
- 周下载：**183**
- 最近 push 2026-09-08

以下几项检查未发现问题（仅作记录）：client 导出齐备、files 白名单、npm 已发布、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「原生鸿蒙开发助手：hdc闭环调试、设备面板、离线官方知识层、DevEco CLI构建/签名/模拟器控制。」。
