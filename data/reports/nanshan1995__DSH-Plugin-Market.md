...
> nanshan1995/DSH-Plugin-Market · 第 1 期（数据快照 2026-09-06）
...
```text
Add nanshan1995/DSH-Plugin-Market to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-plugin-market@1.3.0.
```
