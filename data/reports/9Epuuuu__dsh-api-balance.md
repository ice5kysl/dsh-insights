...
> 9Epuuuu/dsh-api-balance · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DeepSeek account balance readout for DSH Web (dsh-plugin)
- npm：尚未发布
...
```text
Add 9Epuuuu/dsh-api-balance to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
