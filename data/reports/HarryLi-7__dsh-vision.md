...
> HarryLi-7/dsh-vision · 第 1 期（数据快照 2026-09-06）
...
```text
Add HarryLi-7/dsh-vision to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-vision@0.2.0.
```
