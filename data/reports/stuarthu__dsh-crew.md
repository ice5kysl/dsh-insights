...
> stuarthu/dsh-crew · 第 1 期（数据快照 2026-09-21）
...
- ★6 · dsh plugin: run work as a small crew of role agents (product manager, researcher, architect, engineer, QA, code reviewer, security reviewer, doc reviewer) that 
