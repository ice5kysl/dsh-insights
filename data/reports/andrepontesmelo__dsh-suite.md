...
> andrepontesmelo/dsh-suite · 第 1 期（数据快照 2026-09-15）
...
- ★0 · The DSH productivity suite: plugins + agent skills for the DeepSeek Harness, installable in one command.
- npm：`dsh-suite@0.0.1`（1 个版本）
- 周下载：**15**
- 最近 push 2026-09-11
