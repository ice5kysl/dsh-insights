...
> lucaslus/dsh-balance-plugin · 第 1 期（数据快照 2026-09-11）
...
- ★2 · DeepSeek Harness plugin that displays real-time account balances for DeepSeek, Kimi (Moonshot), and Qwen providers.
