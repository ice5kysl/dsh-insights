...
> FengLingYaaa/dsh-gpt-perm-strip · 第 1 期（数据快照 2026-09-15）
...
- ★2 · DSH plugin: strip leftover GPT sandbox_permissions that are not strictly wider than the current session.
- npm：尚未发布
- 最近 push 2026-08-17
