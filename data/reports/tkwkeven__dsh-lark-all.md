...
> tkwkeven/dsh-lark-all · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Feishu/Lark all-in-one channel plugin for DeepSeek Harness (Cordis): WebSocket bridge, parallel task sessions with streaming cards, media in/out, cloud docs, re
- npm：尚未发布
- 最近 push 2026-08-18
