...
> zuoyunlai/lunheng-article-pipeline-dsh · 第 1 期（数据快照 2026-09-14）
...
- ★3 · 论衡（lunheng-article-pipeline）DeepSeek Harness bundle 插件（DSH 适配版）
- npm：`lunheng-article-pipeline@2.5.2-dsh.4`（18 个版本）
- 周下载：**1953**
- 最近 push 2026-09-13
