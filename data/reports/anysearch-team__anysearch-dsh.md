...
> anysearch-team/anysearch-dsh · 第 1 期（数据快照 2026-09-21）
...
- ★422 · AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH)
- npm：`@anysearch/anysearch-dsh@0.1.6`（7 个版本）
- 周下载：**1273**
- 最近 push 2026-09-20

以下几项检查未发现问题（仅作记录）：产物布局规范、files 白名单、npm 已发布、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「为DSH提供网页搜索及高级搜索工具」。
