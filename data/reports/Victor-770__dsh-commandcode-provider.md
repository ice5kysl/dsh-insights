...
> Victor-770/dsh-commandcode-provider · 第 1 期（数据快照 2026-09-11）
...
- ★10 · A Command Code LLM provider plugin for DeepSeek Harness (dsh) — supporting all subscription plans (incl. Go & Pro) via Studio API / gateway.专为 DeepSeek Harness 
