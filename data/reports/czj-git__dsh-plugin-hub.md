...
> czj-git/dsh-plugin-hub · 第 1 期（数据快照 2026-09-21）
...
- ★1 · DeepSeek Harness tools for searching and ranking verified plugins from DSH Plugin Hub
- npm：`@czj-git/dsh-plugin-hub@0.4.1`（5 个版本）
- 周下载：**190**
- 最近 push 2026-09-03
