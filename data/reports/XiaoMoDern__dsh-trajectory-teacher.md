...
> XiaoMoDern/dsh-trajectory-teacher · 第 1 期（数据快照 2026-09-14）
...
- ★1 · /trajectory-teacher: DSH plugin that turns an agent's execution trajectory into a structured post-mortem report (decisions / pitfalls / reusable patterns)
