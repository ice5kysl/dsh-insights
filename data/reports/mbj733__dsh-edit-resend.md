...
> mbj733/dsh-edit-resend · 第 1 期（数据快照 2026-09-21）
...
- ★4 · DeepSeek Harness (DSH) plugin: edit sent messages and resend (stop an in-flight reply, edit, resend), plus branch-based edit / reroll / retry and a version time
