...
> Mongfayi/dsh-recall · 第 1 期（数据快照 2026-09-06）
...
- ★3 · Message recall (撤回) plugin for the DSH Web UI: one undo button on each user message that removes the turn and everything after it, durably, without reverting co
...
```text
Add Mongfayi/dsh-recall to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-recall@0.3.0.
```
