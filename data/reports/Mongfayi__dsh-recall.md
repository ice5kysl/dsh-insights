...
> Mongfayi/dsh-recall · 第 1 期（数据快照 2026-09-15）
...
- ★2 · Message recall (撤回) plugin for the DSH Web UI: one undo button on each user message that removes the turn and everything after it, durably, without reverting co
