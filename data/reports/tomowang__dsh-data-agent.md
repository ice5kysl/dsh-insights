...
> tomowang/dsh-data-agent · 第 1 期（数据快照 2026-09-21）
...
- ★0 · DeepSeek Harness (dsh) plugin for managing database connections, browsing/annotating schemas, and running SQL — from chat or the Settings UI
- npm：`@tomowang/dsh-data-agent@0.3.0`（4 个版本）
- 周下载：**89**
- 最近 push 2026-09-18
