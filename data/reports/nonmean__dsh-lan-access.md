...
> nonmean/dsh-lan-access · 第 1 期（数据快照 2026-09-06）
...
- ★3 · DeepSeek Harness web plugin that adds a LAN access
...
```text
Add nonmean/dsh-lan-access to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-lan-access@0.1.3.
```
