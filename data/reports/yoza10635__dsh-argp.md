...
> yoza10635/dsh-argp · 第 1 期（数据快照 2026-09-14）
...
- ★7 · Guarded context compaction for DeepSeek Harness (dsh): the LLM proposes, deterministic guards dispose — eager per-atom shrink (extract/summary/false under verba
- npm：`dsh-argp@1.0.5`（15 个版本）
- 周下载：**315**
- 最近 push 2026-09-10
