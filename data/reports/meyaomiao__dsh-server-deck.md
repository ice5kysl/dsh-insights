...
> meyaomiao/dsh-server-deck · 第 1 期（数据快照 2026-09-21）
...
- ★6 · 服务器卡片仪表盘 for DeepSeek Harness — card dashboard (status/CPU/mem/disk) + one-click xterm terminal, better-sidebar tab or standalone drawer
- npm：`dsh-server-deck@0.3.0`（5 个版本）
- 周下载：**335**
- 最近 push 2026-09-20
