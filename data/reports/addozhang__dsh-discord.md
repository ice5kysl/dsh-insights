...
> addozhang/dsh-discord · 第 1 期（数据快照 2026-09-21）
...
- ★3 · Discord-first adapter for DeepSeek Harness — sessions, streaming, approvals and controls from a Discord guild.
- npm：`@addozhang/dsh-discord@0.4.0`（8 个版本）
- 周下载：**752**
- 最近 push 2026-09-19
