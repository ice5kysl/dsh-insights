...
> WayneJin0918/dsh-wm · 第 1 期（数据快照 2026-09-21）
...
- ★3 · Playable world-model toolkit for DeepSeek Harness: look at frames, name the 3D / pixel / latent route, measure a run, and RSI the research loop.
- npm：尚未发布
- 最近 push 2026-08-18
