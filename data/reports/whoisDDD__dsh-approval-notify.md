...
> whoisDDD/dsh-approval-notify · 第 1 期（数据快照 2026-09-11）
...
- ★1 · DSH approval/question/completion notifier with native browser notifications and toast fallback. / DSH 审批、提问与完成提醒插件，支持浏览器原生通知和 toast 回退。
- npm：尚未发布
- 最近 push 2026-09-01
