...
> zclDragon/dsh-side-chat · 第 1 期（数据快照 2026-09-11）
...
- ★2 · DSH web plugin: Codex-style /side side conversations — a temporary fork of the current chat in a floating panel, without interrupting the main task.
