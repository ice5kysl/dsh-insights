...
> BaronCyrus/dsh-kimi-subscription · 第 1 期（数据快照 2026-09-14）
...
- ★3 · Use a Kimi Code subscription in DeepSeek Harness with OAuth, quota display, and composer usage
- npm：`dsh-kimi-subscription@1.2.3`（12 个版本）
- 周下载：**797**
- 最近 push 2026-09-11
