...
> fuxin123z/dsh-skill-manage · 第 1 期（数据快照 2026-09-21）
...
- ★2 · DSH plugin: agent-managed procedural memory — a skill_manage tool that lets the agent write, patch, disable and delete its own skills at runtime (user + project
- npm：`dsh-skill-manage@0.2.2`（3 个版本）
- 周下载：**67**
- 最近 push 2026-08-22
