...
> fuxin123z/dsh-skill-manage · 第 1 期（数据快照 2026-09-11）
...
- ★3 · DSH plugin: agent-managed procedural memory — a skill_manage tool that lets the agent write, patch, disable and delete its own skills at runtime (user + project
