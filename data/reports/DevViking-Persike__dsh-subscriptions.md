...
> DevViking-Persike/dsh-subscriptions · 第 1 期（数据快照 2026-09-11）
...
- ★2 · DeepSeek Harness plugin: use your own Claude and ChatGPT/Codex subscriptions as model providers, over each vendor's OAuth sign-in
- npm：尚未发布
- 最近 push 2026-09-08
