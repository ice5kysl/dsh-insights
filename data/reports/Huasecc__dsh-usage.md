...
> Huasecc/dsh-usage · 第 1 期（数据快照 2026-09-06）
...
- ★1 · DeepSeek 用量面板—DSHWeb GUI 余额与Token用量仪表盘
- npm：尚未发布
...
```text
Add Huasecc/dsh-usage to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
