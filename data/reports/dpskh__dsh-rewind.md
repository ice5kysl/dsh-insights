...
> dpskh/dsh-rewind · 第 1 期（数据快照 2026-09-06）
...
- ★3 · Fold everything since the last checkpoint mark into an auto-generated report, replacing it in context while keeping the full log.
- npm：尚未发布
- 最近 push 2026-08-21 · 收录：awesome — · imsai —

**做得好的**：产物布局规范、files 白名单、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「将上次检查点以来的内容折叠为自动报告，替换上下文但保留完整日志。」。这些是你的基本盘，保持即可。
...
```text
Add dpskh/dsh-rewind to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
