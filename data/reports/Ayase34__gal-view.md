...
> Ayase34/gal-view · 第 1 期（数据快照 2026-09-21）
...
- ★182 · 把dsh会话界面切换成galgame游戏界面的插件
- npm：尚未发布
- 最近 push 2026-08-16

以下几项检查未发现问题（仅作记录）：files 白名单、npm 版本同步、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期；按 README 解读，主要能力是「将DSH会话界面切换为Galgame游戏风格，提供视觉主题转换。」。
