...
> AtropinolTT/dsh-auto-review · 第 1 期（数据快照 2026-09-06）
...
```text
Add AtropinolTT/dsh-auto-review to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-auto-review@0.10.4.
```
