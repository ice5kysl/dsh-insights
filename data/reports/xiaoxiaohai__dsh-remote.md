...
> xiaoxiaohai/dsh-remote · 第 1 期（数据快照 2026-09-14）
...
- ★0 · Secure, opt-in phone access for DeepSeek Harness Web on macOS.
- npm：`@musitoolbox/dsh-remote@0.4.0-beta.2`（2 个版本）
- 周下载：**126**
- 最近 push 2026-09-03
