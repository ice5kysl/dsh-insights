...
> Aampidy/dsh-mcmp · 第 1 期（数据快照 2026-09-21）
...
- ★3 · Deepseek-Harness数学建模竞赛论文全自动撰写流水线插件。Deepseek-Harness fully automatic pipeline plugin for writing mathematical modeling competition papers.
- npm：`dsh-mcmp@3.1.2`（20 个版本）
- 周下载：**138**
- 最近 push 2026-09-15
