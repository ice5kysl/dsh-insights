...
> Castor6/BrowserRig · 第 1 期（数据快照 2026-09-15）
...
- ★2 · Open-source local driver for trusted agents to control your existing signed-in Chromium browser without browser-wide remote-debugging approval.
- npm：`browserrig@0.3.1`（5 个版本）
- 周下载：**73**
- 最近 push 2026-09-13
