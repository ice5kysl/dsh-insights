...
> XYZ1024-alt/dsh-side-panel · 第 1 期（数据快照 2026-09-06）
...
```text
Add XYZ1024-alt/dsh-side-panel to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-side-panel@1.0.0.
```
