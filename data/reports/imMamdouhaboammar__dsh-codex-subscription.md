...
> imMamdouhaboammar/dsh-codex-subscription · 第 1 期（数据快照 2026-09-21）
...
- ★1 · Use ChatGPT and Codex subscriptions in DeepSeek Harness with OAuth, quota runway forecast, safe resets, web search, image generation, and Fast mode
- npm：`dsh-codex-subscription-en@1.0.0`（1 个版本）
- 周下载：**31**
- 最近 push 2026-09-07
