...
> wuhobin/dsh-mcp-manage · 第 1 期（数据快照 2026-09-11）
...
- ★1 · dsh plugin: Settings > MCP 服务 management page for DeepSeek Harness (DSH). List/add/edit/delete MCP servers registered in cordis.patch.yml and run a real MCP ini
