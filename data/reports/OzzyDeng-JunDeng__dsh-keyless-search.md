...
> OzzyDeng-JunDeng/dsh-keyless-search · 第 1 期（数据快照 2026-09-21）
...
- ★0 · Keyless web search for the DeepSeek Harness web_search tool — Tavily and Firecrawl no-key access, no account or configuration.
- npm：`dsh-keyless-search@0.1.0`（1 个版本）
- 周下载：**134**
- 最近 push 2026-09-19
