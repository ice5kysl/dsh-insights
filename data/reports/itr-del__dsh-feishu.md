...
> itr-del/dsh-feishu · 第 1 期（数据快照 2026-09-06）
...
- ★2 · Feishu (Lark) IM bridge for DeepSeek Harness (dsh) — a cordis plugin
...
```text
Add itr-del/dsh-feishu to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-feishu@0.0.1.
```
