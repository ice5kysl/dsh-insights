...
> nishuoyang/dsh-wallpaper-bg · 第 1 期（数据快照 2026-09-14）
...
- ★2 · DeepSeek Harness Web UI Standalone Wallpaper Background Plugin: Three sources including built-in wallpapers, custom uploads, and Wallpaper Engine library (read-
- npm：`dsh-wallpaper-bg@0.3.3`（6 个版本）
- 周下载：**267**
- 最近 push 2026-09-12
