...
> ikashana/dsh-notify · 第 1 期（数据快照 2026-09-06）
...
- ★1 · Task-monitoring notification plugin for DeepSeek Harness (dsh): turn/end alerts, human-confirmation with timeout escalation, SAPI voice, HTTP/A2A/MCP channels —
...
```text
Add ikashana/dsh-notify to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-notify@0.1.6.
```
