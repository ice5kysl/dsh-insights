...
> YannZhou/dsh-about · 第 1 期（数据快照 2026-09-14）
...
- ★5 · DeepSeek Harness 设置中心「关于」分区插件：版本信息 + 检查更新（npm latest/next）+ 一键更新自动重启 + GitHub 版本记录 | Settings About tab: check updates & one-click update
- npm：`@yannzhou/dsh-about@1.6.1`（3 个版本）
- 周下载：**123**
- 最近 push 2026-09-08
