...
> superfish058/dsh-llm-proxy · 第 1 期（数据快照 2026-09-21）
...
- ★5 · DSH 模型代理插件：按模型粒度走代理（Clash 等）+ 失败自动重试 + 多模态模型镜像 + 逐模型测试连接，模型列表与官方同步，设置页实时生效。
- npm：`@superfish058/dsh-llm-proxy@1.4.0`（10 个版本）
- 周下载：**351**
- 最近 push 2026-09-16
