...
> Jack-sun-learner/dsh-image-skin · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DSH 图片皮肤插件：导入 PNG/JPG/WebP 自动生成主题配色，可选 Q 版宠物（程序化/AI 生图）
- npm：尚未发布
...
```text
Add Jack-sun-learner/dsh-image-skin to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
