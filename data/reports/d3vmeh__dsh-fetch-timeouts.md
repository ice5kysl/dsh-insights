...
> d3vmeh/dsh-fetch-timeouts · 第 1 期（数据快照 2026-09-21）
...
- ★4 · DeepSeek Harness plugin: raise Node's HTTP timeouts process-wide so slow local models (Ollama, LM Studio) are not cut off at 5 minutes
