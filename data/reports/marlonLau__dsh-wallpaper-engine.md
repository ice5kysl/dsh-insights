...
> marlonLau/dsh-wallpaper-engine · 第 1 期（数据快照 2026-09-06）
...
- ★2 · One-click DSH background switcher backed by local Wallpaper Engine images/videos
...
```text
Add marlonLau/dsh-wallpaper-engine to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as @marlonlau/dsh-wallpaper-engine@0.1.2.
```
