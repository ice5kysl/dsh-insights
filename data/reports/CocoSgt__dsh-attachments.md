...
> CocoSgt/dsh-attachments · 第 1 期（数据快照 2026-09-06）
...
**做得好的**：client 导出齐备、产物布局规范、files 白名单、npm 已发布、npm 版本同步、README 齐备、中文/双语文档、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「DeepSeek Harness附件处理插件，具体功能未知。」。这些是你的基本盘，保持即可。
...
```text
Add CocoSgt/dsh-attachments to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-attachments@0.1.1.
```
