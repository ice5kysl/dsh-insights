...
> dingminhua/dsh-connect-trae · 第 1 期（数据快照 2026-09-15）
...
- ★12 · Connect locally signed-in Trae models to DeepSeek Harness with a read-only credits overview.
- npm：`dsh-connect-trae@1.2.0`（6 个版本）
- 周下载：**417**
- 最近 push 2026-09-14
