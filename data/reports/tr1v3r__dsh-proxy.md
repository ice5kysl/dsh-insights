...
> tr1v3r/dsh-proxy · 第 1 期（数据快照 2026-09-15）
...
- ★1 · Runtime-switchable outbound proxy plugin for the DeepSeek Harness — hot-reload HTTP(S)/SOCKS5 routing via one settings section
- npm：`@tr1v3r/dsh-proxy@0.1.2`（3 个版本）
- 周下载：**37**
- 最近 push 2026-09-09
