...
> ben7am1n/dsh-deepseek-usage · 第 1 期（数据快照 2026-09-06）
...
- ★1 · DeepSeek balance and token usage tools for DeepSeek Harness
...
```text
Add ben7am1n/dsh-deepseek-usage to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-deepseek-usage@0.1.0.
```
