...
> SummerSec/dsh-web-auth · 第 1 期（数据快照 2026-09-14）
...
- ★2 · Transport-level authentication gate for the DeepSeek Harness Web GUI
- npm：`@summersec/dsh-web-auth@0.2.0`（5 个版本）
- 周下载：**156**
- 最近 push 2026-08-30
