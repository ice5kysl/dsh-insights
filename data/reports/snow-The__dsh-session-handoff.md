...
> snow-The/dsh-session-handoff · 第 1 期（数据快照 2026-09-06）
...
- ★2 · Session handoff & context management for DeepSeek Harness: structured handoff docs (export/resume/status) + active context pruning (acp_* via official compactio
- npm：尚未发布
...
```text
Add snow-The/dsh-session-handoff to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2.
```
