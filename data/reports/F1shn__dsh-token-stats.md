...
> F1shn/dsh-token-stats · 第 1 期（数据快照 2026-09-06）
...
**做得好的**：files 白名单、npm 已发布、README 齐备、LICENSE、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「按日/周/月统计Token用量、活动热力图及人民币费用，为DeepSeek Harness提供成本跟踪。」。这些是你的基本盘，保持即可。
...
```text
Add F1shn/dsh-token-stats to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-token-stats@0.2.0.
```
