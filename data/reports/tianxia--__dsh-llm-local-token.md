...
> tianxia--/dsh-llm-local-token · 第 1 期（数据快照 2026-09-21）
...
- ★2 · Stop pasting API keys into DeepSeek Harness — reuse the OAuth tokens your local Codex CLI and Claude Code already hold as model routes, with subscription usage 
