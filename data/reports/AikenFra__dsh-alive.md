...
> AikenFra/dsh-alive · 第 1 期（数据快照 2026-09-21）
...
- ★2 · （无描述）
- npm：`dsh-alive@0.1.2`（3 个版本）
- 周下载：**84**
- 最近 push 2026-09-09

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「未提供描述，仅从名称推断与 Harness 存活检测/保活相关。」。
