...
> a1exsun/dsh-council · 第 1 期（数据快照 2026-09-21）
...
- ★154 · Multi-model council for DeepSeek Harness: independent answers, anonymous peer reviews, and an inspectable final decision.
- npm：`@a1exsun/dsh-council@0.1.0`（1 个版本）
- 周下载：**126**
- 最近 push 2026-09-08
