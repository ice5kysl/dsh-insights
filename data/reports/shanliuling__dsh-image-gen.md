...
> shanliuling/dsh-image-gen · 第 1 期（数据快照 2026-09-21）
...
- ★443 · AI image studio for DeepSeek Harness — generate, edit & compare images in chat, with 500+ prompts, gallery, multi-model workflows and ComfyUI.
- npm：`dsh-image-gen@0.6.10`（28 个版本）
- 周下载：**2662**
- 最近 push 2026-09-20

以下几项检查未发现问题（仅作记录）：client 导出齐备、产物布局规范、files 白名单、npm 已发布、README 齐备、中文/双语文档、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「AI图像工作室，聊天中生成、编辑和对比图片，含500+提示词、画廊和多模型工作流。」。
