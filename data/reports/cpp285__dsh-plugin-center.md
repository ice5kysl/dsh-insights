...
> cpp285/dsh-plugin-center · 第 1 期（数据快照 2026-09-15）
...
- ★16 · A compact discovery and lifecycle console for DeepSeek Harness plugins.
- npm：`dsh-plugin-center@0.1.0`（1 个版本）
- 周下载：**39**
- 最近 push 2026-08-14

以下几项检查未发现问题（仅作记录）：files 白名单、npm 已发布、npm 版本同步、README 齐备、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「简洁的DeepSeek Harness插件发现与生命周期管理控制台」。
...
**能力标签**：plugin、discovery、lifecycle、console
