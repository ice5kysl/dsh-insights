...
> lonelymoon87/dsh-guardian · 第 1 期（数据快照 2026-09-06）
...
```text
Add lonelymoon87/dsh-guardian to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-guardian@0.1.0-alpha.2.
```
