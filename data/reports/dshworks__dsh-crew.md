...
> dshworks/dsh-crew · 第 1 期（数据快照 2026-09-11）
...
- ★2 · Watch Claude Code and Codex work inside dsh: each gets a real terminal pane in your session's workspace that you can type into, plus five tools so the dsh agent
- npm：`@dshworks/dsh-crew@0.2.1`（3 个版本）
- 最近 push 2026-09-09
