...
> phillarmonic/dsh-llm-kimi · 第 1 期（数据快照 2026-09-21）
...
- ★1 · A Kimi K3 connector plugin for the DeepSeek Harness LLM capability
- npm：`@phillarmonic/dsh-llm-kimi@0.1.6-alpha.1`（3 个版本）
- 周下载：**98**
- 最近 push 2026-09-15
