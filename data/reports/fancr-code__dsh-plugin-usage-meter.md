...
> fancr-code/dsh-plugin-usage-meter · 第 1 期（数据快照 2026-09-21）
...
- ★4 · DeepSeek Harness 网页插件：API 用量/费用/余额仪表 — 当日/近7天按模型堆叠柱状图、预算提醒、跨会话账本。
- npm：`dsh-plugin-usage-meter@1.9.0`（17 个版本）
- 周下载：**469**
- 最近 push 2026-09-17
