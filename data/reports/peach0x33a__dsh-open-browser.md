...
> peach0x33a/dsh-open-browser · 第 1 期（数据快照 2026-09-06）
...
```text
Add peach0x33a/dsh-open-browser to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-open-browser@0.1.1.
```
