...
> Final-LX/dsh-ui-customizer · 第 1 期（数据快照 2026-09-06）
...
- ★2 · DeepSeek Harness自定义主题插件
- npm：`dsh-ui-customizer@1.1.0`（1 个版本）
...
```text
Add Final-LX/dsh-ui-customizer to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-ui-customizer@1.1.0.
```
