...
> jaaty/dsh-gsd-bundle · 第 1 期（数据快照 2026-09-15）
...
- ★1 · A DeepSeek Harness bundle reimplementing opengsd-core (Git Ship Done) as host-plane Cordis plugins, replacing the default agent-loop behaviour with the GSD phas
- npm：`@dsh-gsd/bundle@3.0.0`（2 个版本）
- 周下载：**80**
- 最近 push 2026-09-09
