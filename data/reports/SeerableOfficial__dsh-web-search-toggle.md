...
> SeerableOfficial/dsh-web-search-toggle · 第 1 期（数据快照 2026-09-21）
...
- ★1 · DSH plugin: a per-session "Web Search" toggle that forces the agent to search the web before answering.
