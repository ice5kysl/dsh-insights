...
> PerryLink/dsh-permission-rules · 第 1 期（数据快照 2026-09-15）
...
以下几项检查未发现问题（仅作记录）：client 导出齐备、files 白名单、npm 已发布、npm 版本同步、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃；按 README 解读，主要能力是「Claude Code式声明式权限规则：有序allow/deny/ask，支持工具名、参数、路径匹配与会话日志审计。」。
