...
> 173787247/dsh-wsl-workspace · 第 1 期（数据快照 2026-09-06）
...
- ★1 · List WSL distros and validate a Linux workspace path for DSH.
- npm：`dsh-wsl-workspace@0.4.0`（11 个版本）
- 最近 push 2026-09-04 · 收录：awesome-dsh-plugin ✅ · imsai —

**做得好的**：files 白名单、npm 已发布、README 齐备、LICENSE、dsh-plugin topic、已度过新仓观察期、近期活跃 等检查全部通过；按 README 解读，主要能力是「列出WSL发行版并验证DSH的Linux工作区路径。」。这些是你的基本盘，保持即可。
...
```text
Add 173787247/dsh-wsl-workspace to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-wsl-workspace@0.4.0.
```
