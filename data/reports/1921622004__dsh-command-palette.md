...
> 1921622004/dsh-command-palette · 第 1 期（数据快照 2026-09-21）
...
- ★0 · ⌘K 命令面板插件，为 DeepSeek Harness Web GUI 提供：会话切换、设置直达、侧边栏页签与插件集成入口，支持自定义快捷键，手不离键盘完成大部分操作。
- npm：`dsh-palette@0.2.1`（3 个版本）
- 周下载：**293**
- 最近 push 2026-09-20
