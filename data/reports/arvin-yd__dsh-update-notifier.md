...
> arvin-yd/dsh-update-notifier · 第 1 期（数据快照 2026-09-06）
...
```text
Add arvin-yd/dsh-update-notifier to the DSH plugin directory (category ui) — a standard Cordis "bundle" plugin targeting @deepseek-ai/dsh ≥ 0.1.1-rc.2, published as dsh-update-notifier@0.2.1.
```
