...
> Yuuz12/dsh-tavily · 第 1 期（数据快照 2026-09-14）
...
- ★1 · Tavily-backed web search provider plugin for DeepSeek Harness (DSH) — multi-key balance-aware rotation with failover, manageable from the DSH web settings.
- npm：`@yuuz12/dsh-tavily@0.1.0`（1 个版本）
- 周下载：**54**
- 最近 push 2026-08-31
