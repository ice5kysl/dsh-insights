...
> orrinzeng/dsh-cursor-subscription · 第 1 期（数据快照 2026-09-21）
...
- ★6 · Log directly into your Cursor account within DeepSeek Harness and use your Cursor subscription — no API Key required, and no dependency on Cursor IDE or Cursor 
- npm：`dsh-cursor-subscription@0.6.2`（8 个版本）
- 周下载：**567**
- 最近 push 2026-09-20
