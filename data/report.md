...
> 权威集 10190 个插件 · 生成于 2026-09-10 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**10190**
- 近 7 天活跃：1715（16.8%）· 近 30 天：10190（100%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：10129（99.4%）

## 发布与文档
- npm 已发布 4274 / 未发布 5916 / 已发布但版本滞后 1214
- 有 README 10163 · 中英双语/中文 4904 · 中文 README 文件 786 · 无 README 27
- lib/index.js 5498 · lib/client.js 3437 · 双产物 3079

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 754 · imsai 243 · 至少一个渠道 992（9.7%） · 未收录 9198
...
## 质量评分（启发式）
- 平均分 75.9 · S+A 占比 10.1%（值得优先看；A+B 55.3%）
- S 250 · A 784 · B 4846 · C 3051 · D 1259
