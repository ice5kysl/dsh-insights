...
> 权威集 11594 个插件 · 生成于 2026-09-18 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11594**
- 近 7 天活跃：1928（16.6%）· 近 30 天：8485（73.2%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11230（96.9%）

## 发布与文档
- npm 已发布 5183 / 未发布 6411 / 已发布但版本滞后 2672
- 有 README 11565 · 中英双语/中文 5525 · 中文 README 文件 868 · 无 README 29
- lib/index.js 6227 · lib/client.js 4005 · 双产物 3577

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 764 · imsai 274 · 至少一个渠道 1033（8.9%） · 未收录 10561
...
## 质量评分（启发式）
- 平均分 74.9 · S+A 占比 6.8%（值得优先看；A+B 53.7%）
- S 166 · A 627 · B 5598 · C 3659 · D 1544
...
- `plugin` × 733
- `typescript` × 425
- `deepseek-harness-plugin` × 400
- `dsh-plugin-market` × 398
- `ai-agent` × 350
- `ai-agents` × 312
