...
> 权威集 11506 个插件 · 生成于 2026-09-17 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11506**
- 近 7 天活跃：2267（19.7%）· 近 30 天：8715（75.7%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11143（96.8%）

## 发布与文档
- npm 已发布 5153 / 未发布 6353 / 已发布但版本滞后 2655
- 有 README 11477 · 中英双语/中文 5490 · 中文 README 文件 865 · 无 README 29
- lib/index.js 6177 · lib/client.js 3965 · 双产物 3541

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 773 · imsai 274 · 至少一个渠道 1042（9.1%） · 未收录 10464
...
## 质量评分（启发式）
- 平均分 75 · S+A 占比 7%（值得优先看；A+B 54.3%）
- S 176 · A 625 · B 5619 · C 3571 · D 1515
