...
> 权威集 11730 个插件 · 生成于 2026-09-20 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11730**
- 近 7 天活跃：1451（12.4%）· 近 30 天：7003（59.7%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11378（97%）

## 发布与文档
- npm 已发布 5235 / 未发布 6495 / 已发布但版本滞后 2687
- 有 README 11701 · 中英双语/中文 5591 · 中文 README 文件 876 · 无 README 29
- lib/index.js 6298 · lib/client.js 4074 · 双产物 3635

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 763 · imsai 275 · 至少一个渠道 1033（8.8%） · 未收录 10697
...
## 质量评分（启发式）
- 平均分 74.2 · S+A 占比 6.6%（值得优先看；A+B 52.4%）
- S 158 · A 622 · B 5522 · C 3712 · D 1716
