...
> 权威集 11522 个插件 · 生成于 2026-09-18 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11522**
- 近 7 天活跃：2189（19%）· 近 30 天：8650（75.1%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11163（96.9%）

## 发布与文档
- npm 已发布 5161 / 未发布 6361 / 已发布但版本滞后 2661
- 有 README 11493 · 中英双语/中文 5494 · 中文 README 文件 867 · 无 README 29
- lib/index.js 6184 · lib/client.js 3972 · 双产物 3546

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 771 · imsai 274 · 至少一个渠道 1040（9%） · 未收录 10482
...
## 质量评分（启发式）
- 平均分 75 · S+A 占比 6.9%（值得优先看；A+B 54.1%）
- S 174 · A 626 · B 5602 · C 3597 · D 1523
