...
> 权威集 11526 个插件 · 生成于 2026-09-18 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11526**
- 近 7 天活跃：2118（18.4%）· 近 30 天：8621（74.8%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11175（97%）

## 发布与文档
- npm 已发布 5162 / 未发布 6364 / 已发布但版本滞后 2661
- 有 README 11497 · 中英双语/中文 5497 · 中文 README 文件 867 · 无 README 29
- lib/index.js 6188 · lib/client.js 3976 · 双产物 3550

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 764 · imsai 274 · 至少一个渠道 1033（9%） · 未收录 10493
...
## 质量评分（启发式）
- 平均分 75 · S+A 占比 6.9%（值得优先看；A+B 54%）
- S 173 · A 625 · B 5602 · C 3601 · D 1525
