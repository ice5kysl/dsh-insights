...
> 权威集 11476 个插件 · 生成于 2026-09-17 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11476**
- 近 7 天活跃：2384（20.8%）· 近 30 天：8769（76.4%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11124（96.9%）

## 发布与文档
- npm 已发布 5145 / 未发布 6331 / 已发布但版本滞后 2653
- 有 README 11447 · 中英双语/中文 5476 · 中文 README 文件 865 · 无 README 29
- lib/index.js 6162 · lib/client.js 3953 · 双产物 3533

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 773 · imsai 274 · 至少一个渠道 1042（9.1%） · 未收录 10434
...
## 质量评分（启发式）
- 平均分 75.1 · S+A 占比 7%（值得优先看；A+B 54.4%）
- S 176 · A 628 · B 5616 · C 3547 · D 1509
...
- `plugin` × 729
- `typescript` × 422
- `deepseek-harness-plugin` × 397
- `dsh-plugin-market` × 396
- `ai-agent` × 344
- `ai-agents` × 309
