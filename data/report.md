...
> 权威集 11621 个插件 · 生成于 2026-09-19 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11621**
- 近 7 天活跃：1796（15.5%）· 近 30 天：8008（68.9%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11260（96.9%）

## 发布与文档
- npm 已发布 5201 / 未发布 6420 / 已发布但版本滞后 2676
- 有 README 11592 · 中英双语/中文 5536 · 中文 README 文件 868 · 无 README 29
- lib/index.js 6242 · lib/client.js 4018 · 双产物 3589

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 765 · imsai 275 · 至少一个渠道 1035（8.9%） · 未收录 10586
...
## 质量评分（启发式）
- 平均分 74.7 · S+A 占比 6.8%（值得优先看；A+B 52.9%）
- S 164 · A 627 · B 5518 · C 3697 · D 1615
