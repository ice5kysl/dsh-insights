...
> 权威集 10933 个插件 · 生成于 2026-09-13 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**10933**
- 近 7 天活跃：2519（23%）· 近 30 天：10933（100%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：10490（95.9%）

## 发布与文档
- npm 已发布 4588 / 未发布 6345 / 已发布但版本滞后 1300
- 有 README 10904 · 中英双语/中文 5229 · 中文 README 文件 824 · 无 README 29
- lib/index.js 5897 · lib/client.js 3734 · 双产物 3347

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 762 · imsai 266 · 至少一个渠道 1023（9.4%） · 未收录 9910

## 优质未收录 · 建议收录（Top 15）
- TsFreddie/dsh-compaction-instant A
- Simon314620/dsh-turn-index A
- DGPisces/dsh-openai-oauth A
- hrhgit/dsh-model-manager A
- spoon-man569/dsh-token-price A · 周下载 174
- PaRr0tBoY/dsh-toc-and-rewind A
- belowthetree/dsh-mcp-setting A
- spacexun2/dsh-worktime-board A
- Ultronen/dsh-liquid-glass A
- sfyyy/dsh-vision-bridge A
- yangzhe1991/dsh-code-review A
- hyper-dsh-plugins/dsh-open-file A
- MayBeTheWorld/dsh-inherit A
- mrzhangkris/dsh-session-pruner A
- f20880479-lab/dsh-peak-gate A

## npm 周下载 Top 10
- dsh-market/dsh-market：86927
- KokuYu-sysu/dsh-market-desktop：86927
- omdsh-dev/DSH-better-sidebar：73829
- bowenliang123/dsh-context：25269
- dream-num/dsh-univer-office：18211
- Han-1413141/dsh-cost-meter：17298
- Creakono/dsh-cost-meter：17298
- AnakinCao/dsh-cost-meter：17298
- omdsh-dev/dsh-mnemon：9063
- ysr666/dsh-vision-router：8706

## 质量评分（启发式）
- 平均分 76.1 · S+A 占比 10.2%（值得优先看；A+B 55.8%）
- S 269 · A 847 · B 5254 · C 3296 · D 1267
...
- `plugin` × 687
- `typescript` × 406
- `deepseek-harness-plugin` × 382
- `dsh-plugin-market` × 379
- `ai-agent` × 323
- `ai-agents` × 285
