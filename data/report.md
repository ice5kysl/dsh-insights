...
> 权威集 11465 个插件 · 生成于 2026-09-17 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11465**
- 近 7 天活跃：2443（21.3%）· 近 30 天：8801（76.8%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11120（97%）

## 发布与文档
- npm 已发布 5142 / 未发布 6323 / 已发布但版本滞后 2650
- 有 README 11436 · 中英双语/中文 5472 · 中文 README 文件 863 · 无 README 29
- lib/index.js 6153 · lib/client.js 3949 · 双产物 3529

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 773 · imsai 274 · 至少一个渠道 1042（9.1%） · 未收录 10423
...
## 质量评分（启发式）
- 平均分 75.1 · S+A 占比 7%（值得优先看；A+B 54.5%）
- S 176 · A 631 · B 5623 · C 3529 · D 1506
