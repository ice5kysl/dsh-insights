...
> 权威集 11683 个插件 · 生成于 2026-09-19 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11683**
- 近 7 天活跃：1570（13.4%）· 近 30 天：7321（62.7%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11342（97.1%）

## 发布与文档
- npm 已发布 5222 / 未发布 6461 / 已发布但版本滞后 2683
- 有 README 11654 · 中英双语/中文 5572 · 中文 README 文件 874 · 无 README 29
- lib/index.js 6276 · lib/client.js 4047 · 双产物 3615

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 765 · imsai 275 · 至少一个渠道 1035（8.9%） · 未收录 10648
...
## 质量评分（启发式）
- 平均分 74.3 · S+A 占比 6.7%（值得优先看；A+B 52.6%）
- S 160 · A 623 · B 5517 · C 3696 · D 1687
...
- `plugin` × 738
- `typescript` × 426
- `deepseek-harness-plugin` × 403
- `dsh-plugin-market` × 400
- `ai-agent` × 351
- `ai-agents` × 315
