...
> 权威集 11124 个插件 · 生成于 2026-09-14 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11124**
- 近 7 天活跃：2780（25%）· 近 30 天：11124（100%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：10564（95%）

## 发布与文档
- npm 已发布 4662 / 未发布 6462 / 已发布但版本滞后 1330
- 有 README 11095 · 中英双语/中文 5317 · 中文 README 文件 836 · 无 README 29
- lib/index.js 5987 · lib/client.js 3807 · 双产物 3403

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 769 · imsai 269 · 至少一个渠道 1033（9.3%） · 未收录 10091
...
## 质量评分（启发式）
- 平均分 76.1 · S+A 占比 10.1%（值得优先看；A+B 55.9%）
- S 272 · A 856 · B 5357 · C 3370 · D 1269
