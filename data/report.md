...
> 权威集 11510 个插件 · 生成于 2026-09-17 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11510**
- 近 7 天活跃：2237（19.4%）· 近 30 天：8696（75.6%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11152（96.9%）

## 发布与文档
- npm 已发布 5156 / 未发布 6354 / 已发布但版本滞后 2656
- 有 README 11481 · 中英双语/中文 5491 · 中文 README 文件 866 · 无 README 29
- lib/index.js 6180 · lib/client.js 3967 · 双产物 3543

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 773 · imsai 274 · 至少一个渠道 1042（9.1%） · 未收录 10468
...
## 质量评分（启发式）
- 平均分 75 · S+A 占比 7%（值得优先看；A+B 54.2%）
- S 175 · A 627 · B 5611 · C 3580 · D 1517
