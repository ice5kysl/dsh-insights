...
> 权威集 12058 个插件 · 生成于 2026-09-22 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**12058**
- 近 7 天活跃：2059（17.1%）· 近 30 天：6746（55.9%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11678（96.8%）

## 发布与文档
- npm 已发布 5356 / 未发布 6702 / 已发布但版本滞后 2725
- 有 README 12029 · 中英双语/中文 5718 · 中文 README 文件 897 · 无 README 29
- lib/index.js 6475 · lib/client.js 4212 · 双产物 3756

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 757 · imsai 280 · 至少一个渠道 1032（8.6%） · 未收录 11026
...
## 质量评分（启发式）
- 平均分 74.1 · S+A 占比 6.4%（值得优先看；A+B 52.2%）
- S 150 · A 622 · B 5675 · C 3823 · D 1788
...
- `plugin` × 771
- `typescript` × 446
- `deepseek-harness-plugin` × 419
- `dsh-plugin-market` × 414
- `ai-agent` × 378
- `ai-agents` × 329
