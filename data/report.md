...
> 权威集 11483 个插件 · 生成于 2026-09-17 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11483**
- 近 7 天活跃：2359（20.5%）· 近 30 天：8761（76.3%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11128（96.9%）

## 发布与文档
- npm 已发布 5146 / 未发布 6337 / 已发布但版本滞后 2654
- 有 README 11454 · 中英双语/中文 5478 · 中文 README 文件 865 · 无 README 29
- lib/index.js 6168 · lib/client.js 3956 · 双产物 3536

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 773 · imsai 274 · 至少一个渠道 1042（9.1%） · 未收录 10441
...
## 质量评分（启发式）
- 平均分 75 · S+A 占比 7%（值得优先看；A+B 54.4%）
- S 176 · A 628 · B 5615 · C 3553 · D 1511
