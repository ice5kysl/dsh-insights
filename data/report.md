...
> 权威集 11717 个插件 · 生成于 2026-09-20 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11717**
- 近 7 天活跃：1497（12.8%）· 近 30 天：7014（59.9%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11369（97%）

## 发布与文档
- npm 已发布 5233 / 未发布 6484 / 已发布但版本滞后 2686
- 有 README 11688 · 中英双语/中文 5589 · 中文 README 文件 876 · 无 README 29
- lib/index.js 6291 · lib/client.js 4067 · 双产物 3629

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 763 · imsai 275 · 至少一个渠道 1033（8.8%） · 未收录 10684
...
## 质量评分（启发式）
- 平均分 74.2 · S+A 占比 6.7%（值得优先看；A+B 52.4%）
- S 160 · A 622 · B 5519 · C 3702 · D 1714
...
- `plugin` × 743
- `typescript` × 426
- `deepseek-harness-plugin` × 405
- `dsh-plugin-market` × 401
- `ai-agent` × 352
- `ai-agents` × 316
