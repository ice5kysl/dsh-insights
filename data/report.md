...
> 权威集 11583 个插件 · 生成于 2026-09-18 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11583**
- 近 7 天活跃：1995（17.2%）· 近 30 天：8520（73.6%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11216（96.8%）

## 发布与文档
- npm 已发布 5183 / 未发布 6400 / 已发布但版本滞后 2672
- 有 README 11554 · 中英双语/中文 5520 · 中文 README 文件 868 · 无 README 29
- lib/index.js 6222 · lib/client.js 4000 · 双产物 3574

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 764 · imsai 274 · 至少一个渠道 1033（8.9%） · 未收录 10550
...
## 质量评分（启发式）
- 平均分 74.9 · S+A 占比 6.9%（值得优先看；A+B 53.7%）
- S 166 · A 628 · B 5597 · C 3656 · D 1536
