...
> 权威集 11449 个插件 · 生成于 2026-09-17 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11449**
- 近 7 天活跃：2484（21.7%）· 近 30 天：8839（77.2%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11106（97%）

## 发布与文档
- npm 已发布 5140 / 未发布 6309 / 已发布但版本滞后 2649
- 有 README 11420 · 中英双语/中文 5465 · 中文 README 文件 861 · 无 README 29
- lib/index.js 6147 · lib/client.js 3944 · 双产物 3525

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 773 · imsai 272 · 至少一个渠道 1040（9.1%） · 未收录 10409
...
## 质量评分（启发式）
- 平均分 75.1 · S+A 占比 7.1%（值得优先看；A+B 54.6%）
- S 176 · A 632 · B 5622 · C 3515 · D 1504
