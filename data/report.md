...
> 权威集 12251 个插件 · 生成于 2026-09-24 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**12251**
- 近 7 天活跃：1702（13.9%）· 近 30 天：6525（53.3%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11893（97.1%）

## 发布与文档
- npm 已发布 5413 / 未发布 6838 / 已发布但版本滞后 2747
- 有 README 12222 · 中英双语/中文 5791 · 中文 README 文件 903 · 无 README 29
- lib/index.js 6580 · lib/client.js 4298 · 双产物 3829

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 765 · imsai 284 · 至少一个渠道 1044（8.5%） · 未收录 11207
...
## 质量评分（启发式）
- 平均分 73.9 · S+A 占比 5.9%（值得优先看；A+B 51.6%）
- S 151 · A 575 · B 5750 · C 3951 · D 1824
...
- `plugin` × 779
- `typescript` × 453
- `deepseek-harness-plugin` × 423
- `dsh-plugin-market` × 419
- `ai-agent` × 382
- `ai-agents` × 333
...
| repo | ★ | 仓库版本 → npm |
|---|---|---|
| dsh-market/dsh-market | 4262 | 1.43.0 → 1.59.0 |
| liustack/modlens | 4000 | 3.25.4 → 3.26.3 |
| MeteorNOX/DeepSeek-Balance-Whale-Widget | 2809 | 0.2.10 → 0.3.11 |
| bowenliang123/dsh-context | 1453 | 0.42.0 → 0.55.0 |
| xmanrui/dsh-im | 1417 | 4.11.0 → 4.28.0 |
| shaobeichen/dsh-pocket | 1258 | 2.10.3 → 2.10.6 |
| GanyuanRan/Aegis | 1224 | 2.9.6 → 0.1.0 |
| ysr666/dsh-vision-router | 1113 | 2.1.2 → 2.2.1 |
| vshulcz/deja-vu | 898 | 0.20.5 → 0.21.1 |
