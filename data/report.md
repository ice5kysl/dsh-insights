...
> 权威集 11222 个插件 · 生成于 2026-09-15 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11222**
- 近 7 天活跃：2787（24.8%）· 近 30 天：11220（100%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：10590（94.4%）

## 发布与文档
- npm 已发布 4690 / 未发布 6532 / 已发布但版本滞后 1340
- 有 README 11193 · 中英双语/中文 5349 · 中文 README 文件 839 · 无 README 29
- lib/index.js 6026 · lib/client.js 3842 · 双产物 3434

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 769 · imsai 269 · 至少一个渠道 1033（9.2%） · 未收录 10189
...
- Nicercz007-cloud/schedule：36595
- biyuhao/dsh-model-proxy：27145
- bowenliang123/dsh-context：25269
- jkStars/dsh-token-usage-stats：23578
- meyaomiao/dsh-server-deck：19711
- dream-num/dsh-univer-office：18211
- Han-1413141/dsh-cost-meter：17298

## 质量评分（启发式）
- 平均分 76.1 · S+A 占比 10.1%（值得优先看；A+B 55.8%）
- S 272 · A 860 · B 5397 · C 3418 · D 1275
...
- `plugin` × 707
- `typescript` × 413
- `deepseek-harness-plugin` × 394
- `dsh-plugin-market` × 384
- `ai-agent` × 331
- `ai-agents` × 303
