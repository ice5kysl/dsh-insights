...
> 权威集 11574 个插件 · 生成于 2026-09-18 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11574**
- 近 7 天活跃：2010（17.4%）· 近 30 天：8536（73.8%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11209（96.8%）

## 发布与文档
- npm 已发布 5180 / 未发布 6394 / 已发布但版本滞后 2670
- 有 README 11545 · 中英双语/中文 5518 · 中文 README 文件 868 · 无 README 29
- lib/index.js 6218 · lib/client.js 3999 · 双产物 3573

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 764 · imsai 274 · 至少一个渠道 1033（8.9%） · 未收录 10541
...
## 质量评分（启发式）
- 平均分 74.9 · S+A 占比 6.9%（值得优先看；A+B 53.8%）
- S 168 · A 627 · B 5597 · C 3647 · D 1535
