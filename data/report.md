...
> 权威集 12206 个插件 · 生成于 2026-09-24 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**12206**
- 近 7 天活跃：1785（14.6%）· 近 30 天：6606（54.1%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11841（97%）

## 发布与文档
- npm 已发布 5402 / 未发布 6804 / 已发布但版本滞后 2745
- 有 README 12177 · 中英双语/中文 5774 · 中文 README 文件 902 · 无 README 29
- lib/index.js 6553 · lib/client.js 4276 · 双产物 3808

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 766 · imsai 284 · 至少一个渠道 1045（8.6%） · 未收录 11161
...
## 质量评分（启发式）
- 平均分 74 · S+A 占比 6.1%（值得优先看；A+B 51.8%）
- S 150 · A 589 · B 5734 · C 3922 · D 1811
...
- `plugin` × 777
- `typescript` × 451
- `deepseek-harness-plugin` × 422
- `dsh-plugin-market` × 417
- `ai-agent` × 382
- `ai-agents` × 333
