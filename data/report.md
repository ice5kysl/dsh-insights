...
> 权威集 11446 个插件 · 生成于 2026-09-17 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11446**
- 近 7 天活跃：2508（21.9%）· 近 30 天：8857（77.4%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11103（97%）

## 发布与文档
- npm 已发布 5139 / 未发布 6307 / 已发布但版本滞后 2649
- 有 README 11417 · 中英双语/中文 5464 · 中文 README 文件 860 · 无 README 29
- lib/index.js 6145 · lib/client.js 3942 · 双产物 3523

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 773 · imsai 272 · 至少一个渠道 1040（9.1%） · 未收录 10406
...
## 质量评分（启发式）
- 平均分 75.1 · S+A 占比 7.1%（值得优先看；A+B 54.7%）
- S 176 · A 633 · B 5623 · C 3512 · D 1502
