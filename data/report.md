...
> 权威集 10189 个插件 · 生成于 2026-09-07 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**10189**
- 近 7 天活跃：2503（24.6%）· 近 30 天：10189（100%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：10127（99.4%）

## 发布与文档
- npm 已发布 4273 / 未发布 5916 / 已发布但版本滞后 1214
- 有 README 10162 · 中英双语/中文 4903 · 中文 README 文件 785 · 无 README 27
- lib/index.js 5497 · lib/client.js 3436 · 双产物 3078

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 767 · imsai 238 · 至少一个渠道 1000（9.8%） · 未收录 9189
...
## 质量评分（启发式）
- 平均分 76 · S+A 占比 10.2%（值得优先看；A+B 55.6%）
- S 248 · A 787 · B 4875 · C 3030 · D 1249
...
- `plugin` × 640
- `typescript` × 386
- `dsh-plugin-market` × 366
- `deepseek-harness-plugin` × 354
- `ai-agent` × 304
- `ai-agents` × 279
