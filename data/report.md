...
> 权威集 11604 个插件 · 生成于 2026-09-18 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11604**
- 近 7 天活跃：1883（16.2%）· 近 30 天：8163（70.3%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11245（96.9%）

## 发布与文档
- npm 已发布 5189 / 未发布 6415 / 已发布但版本滞后 2672
- 有 README 11575 · 中英双语/中文 5529 · 中文 README 文件 868 · 无 README 29
- lib/index.js 6231 · lib/client.js 4008 · 双产物 3580

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 765 · imsai 274 · 至少一个渠道 1034（8.9%） · 未收录 10570
...
## 质量评分（启发式）
- 平均分 74.7 · S+A 占比 6.8%（值得优先看；A+B 53.1%）
- S 164 · A 627 · B 5529 · C 3707 · D 1577
