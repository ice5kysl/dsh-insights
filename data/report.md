...
> 权威集 11602 个插件 · 生成于 2026-09-18 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11602**
- 近 7 天活跃：1888（16.3%）· 近 30 天：8298（71.5%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11242（96.9%）

## 发布与文档
- npm 已发布 5189 / 未发布 6413 / 已发布但版本滞后 2672
- 有 README 11573 · 中英双语/中文 5527 · 中文 README 文件 868 · 无 README 29
- lib/index.js 6229 · lib/client.js 4006 · 双产物 3578

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 765 · imsai 274 · 至少一个渠道 1034（8.9%） · 未收录 10568
...
## 质量评分（启发式）
- 平均分 74.8 · S+A 占比 6.8%（值得优先看；A+B 53%）
- S 166 · A 625 · B 5528 · C 3718 · D 1565
