...
> 权威集 11689 个插件 · 生成于 2026-09-19 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11689**
- 近 7 天活跃：1559（13.3%）· 近 30 天：7146（61.1%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11343（97%）

## 发布与文档
- npm 已发布 5224 / 未发布 6465 / 已发布但版本滞后 2685
- 有 README 11660 · 中英双语/中文 5576 · 中文 README 文件 874 · 无 README 29
- lib/index.js 6280 · lib/client.js 4051 · 双产物 3619

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 765 · imsai 275 · 至少一个渠道 1035（8.9%） · 未收录 10654
...
## 质量评分（启发式）
- 平均分 74.3 · S+A 占比 6.7%（值得优先看；A+B 52.5%）
- S 160 · A 623 · B 5519 · C 3695 · D 1692
