...
> 权威集 11679 个插件 · 生成于 2026-09-19 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11679**
- 近 7 天活跃：1596（13.7%）· 近 30 天：7608（65.1%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11335（97.1%）

## 发布与文档
- npm 已发布 5220 / 未发布 6459 / 已发布但版本滞后 2683
- 有 README 11650 · 中英双语/中文 5568 · 中文 README 文件 873 · 无 README 29
- lib/index.js 6274 · lib/client.js 4044 · 双产物 3613

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 765 · imsai 275 · 至少一个渠道 1035（8.9%） · 未收录 10644
...
## 质量评分（启发式）
- 平均分 74.5 · S+A 占比 6.7%（值得优先看；A+B 52.6%）
- S 160 · A 623 · B 5517 · C 3712 · D 1667
