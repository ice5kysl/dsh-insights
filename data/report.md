...
> 权威集 11662 个插件 · 生成于 2026-09-19 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11662**
- 近 7 天活跃：1650（14.1%）· 近 30 天：7876（67.5%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11319（97.1%）

## 发布与文档
- npm 已发布 5215 / 未发布 6447 / 已发布但版本滞后 2681
- 有 README 11633 · 中英双语/中文 5560 · 中文 README 文件 873 · 无 README 29
- lib/index.js 6264 · lib/client.js 4037 · 双产物 3606

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 766 · imsai 275 · 至少一个渠道 1036（8.9%） · 未收录 10626
...
## 质量评分（启发式）
- 平均分 74.6 · S+A 占比 6.7%（值得优先看；A+B 52.6%）
- S 161 · A 623 · B 5517 · C 3737 · D 1624
