...
> 权威集 11627 个插件 · 生成于 2026-09-19 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11627**
- 近 7 天活跃：1766（15.2%）· 近 30 天：7987（68.7%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11263（96.9%）

## 发布与文档
- npm 已发布 5202 / 未发布 6425 / 已发布但版本滞后 2676
- 有 README 11598 · 中英双语/中文 5538 · 中文 README 文件 868 · 无 README 29
- lib/index.js 6247 · lib/client.js 4021 · 双产物 3592

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 766 · imsai 275 · 至少一个渠道 1036（8.9%） · 未收录 10591
...
## 质量评分（启发式）
- 平均分 74.6 · S+A 占比 6.8%（值得优先看；A+B 52.8%）
- S 163 · A 627 · B 5509 · C 3712 · D 1616
...
- `plugin` × 734
- `typescript` × 425
- `deepseek-harness-plugin` × 401
- `dsh-plugin-market` × 399
- `ai-agent` × 350
- `ai-agents` × 313
...
| vshulcz/deja-vu | 811 | 0.20.5 → 0.20.9 |
