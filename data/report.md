...
> 权威集 12409 个插件 · 生成于 2026-09-26 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**12409**
- 近 7 天活跃：1275（10.3%）· 近 30 天：6349（51.2%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：12025（96.9%）

## 发布与文档
- npm 已发布 5549 / 未发布 6860 / 已发布但版本滞后 3012
- 有 README 12378 · 中英双语/中文 5869 · 中文 README 文件 909 · 无 README 31
- lib/index.js 6667 · lib/client.js 4361 · 双产物 3882

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 763 · imsai 286 · 至少一个渠道 1044（8.4%） · 未收录 11365
...
## 质量评分（启发式）
- 平均分 73.8 · S+A 占比 5.4%（值得优先看；A+B 51.5%）
- S 132 · A 532 · B 5862 · C 4038 · D 1845
...
- `plugin` × 795
- `typescript` × 457
- `deepseek-harness-plugin` × 431
- `dsh-plugin-market` × 421
- `ai-agent` × 390
- `ai-agents` × 337
