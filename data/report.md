...
> 权威集 11651 个插件 · 生成于 2026-09-19 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11651**
- 近 7 天活跃：1667（14.3%）· 近 30 天：7908（67.9%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11308（97.1%）

## 发布与文档
- npm 已发布 5211 / 未发布 6440 / 已发布但版本滞后 2679
- 有 README 11622 · 中英双语/中文 5554 · 中文 README 文件 871 · 无 README 29
- lib/index.js 6258 · lib/client.js 4032 · 双产物 3602

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 766 · imsai 275 · 至少一个渠道 1036（8.9%） · 未收录 10615
...
## 质量评分（启发式）
- 平均分 74.6 · S+A 占比 6.8%（值得优先看；A+B 52.7%）
- S 162 · A 625 · B 5511 · C 3731 · D 1622
