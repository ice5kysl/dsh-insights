...
> 权威集 11459 个插件 · 生成于 2026-09-17 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11459**
- 近 7 天活跃：2465（21.5%）· 近 30 天：8821（77%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11111（97%）

## 发布与文档
- npm 已发布 5142 / 未发布 6317 / 已发布但版本滞后 2650
- 有 README 11430 · 中英双语/中文 5470 · 中文 README 文件 862 · 无 README 29
- lib/index.js 6152 · lib/client.js 3947 · 双产物 3528

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 773 · imsai 272 · 至少一个渠道 1040（9.1%） · 未收录 10419
...
## 质量评分（启发式）
- 平均分 75.1 · S+A 占比 7%（值得优先看；A+B 54.6%）
- S 176 · A 631 · B 5622 · C 3524 · D 1506
