...
> 权威集 11538 个插件 · 生成于 2026-09-18 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11538**
- 近 7 天活跃：2088（18.1%）· 近 30 天：8605（74.6%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11179（96.9%）

## 发布与文档
- npm 已发布 5170 / 未发布 6368 / 已发布但版本滞后 2665
- 有 README 11509 · 中英双语/中文 5503 · 中文 README 文件 867 · 无 README 29
- lib/index.js 6196 · lib/client.js 3983 · 双产物 3557

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 764 · imsai 274 · 至少一个渠道 1033（9%） · 未收录 10505
...
## 质量评分（启发式）
- 平均分 74.9 · S+A 占比 6.9%（值得优先看；A+B 54%）
- S 172 · A 627 · B 5602 · C 3609 · D 1528
