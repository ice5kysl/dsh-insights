...
> 权威集 11752 个插件 · 生成于 2026-09-20 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11752**
- 近 7 天活跃：1425（12.1%）· 近 30 天：6929（59%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：11393（96.9%）

## 发布与文档
- npm 已发布 5238 / 未发布 6514 / 已发布但版本滞后 2688
- 有 README 11723 · 中英双语/中文 5603 · 中文 README 文件 876 · 无 README 29
- lib/index.js 6313 · lib/client.js 4084 · 双产物 3645

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 763 · imsai 275 · 至少一个渠道 1033（8.8%） · 未收录 10719
...
## 质量评分（启发式）
- 平均分 74.2 · S+A 占比 6.6%（值得优先看；A+B 52.3%）
- S 156 · A 617 · B 5531 · C 3722 · D 1726
