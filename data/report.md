...
> 权威集 11391 个插件 · 生成于 2026-09-16 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**11391**
- 近 7 天活跃：2613（22.9%）· 近 30 天：11389（100%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：10626（93.3%）

## 发布与文档
- npm 已发布 4753 / 未发布 6638 / 已发布但版本滞后 1365
- 有 README 11362 · 中英双语/中文 5437 · 中文 README 文件 854 · 无 README 29
- lib/index.js 6121 · lib/client.js 3919 · 双产物 3503

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 773 · imsai 271 · 至少一个渠道 1039（9.1%） · 未收录 10352
...
## 质量评分（启发式）
- 平均分 76.1 · S+A 占比 10%（值得优先看；A+B 55.6%）
- S 273 · A 864 · B 5475 · C 3492 · D 1287
...
- `plugin` × 720
- `typescript` × 419
- `deepseek-harness-plugin` × 395
- `dsh-plugin-market` × 395
- `ai-agent` × 336
- `ai-agents` × 307
